...
<div class="research-canvas">
  ...
  <section class="research-canvas__inventory" data-reveal>
    <header><p class="research-canvas__eyebrow">Canonical data</p><h2>Start from contracts, not from assumptions.</h2><p>The current manifest contains 78 structured cases across core and specialist sets.</p></header>
    <div class="research-route-list">
