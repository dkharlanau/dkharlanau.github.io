...
<div class="research-canvas">
  ...
  <section class="research-canvas__inventory" id="domain-master" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="https://help.sap.com/S4_CE_MO" target="_blank" rel="noopener"><span>MM</span><strong>Purchasing contracts</strong><small>Open outline agreements can be part of day-one procurement. Restrictions exist for item categories and service scenarios, so inspect the object documentation.</small><i class="material-symbols-outlined" aria-hidden="true">contract</i></a>
  ...
  <section class="research-canvas__inventory" id="open-business" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="https://help.sap.com/S4_CE_MO" target="_blank" rel="noopener"><span>PP</span><strong>Open production orders</strong><small>Supported statuses and resulting target status are object-specific. Reconcile reservations, components, quantities and execution state with the production cutover plan.</small><i class="material-symbols-outlined" aria-hidden="true">manufacturing</i></a>
      <a href="https://help.sap.com/S4_CE_MO" target="_blank" rel="noopener"><span>PM</span><strong>Open maintenance orders</strong><small>Move only work that must continue in S/4 and only with the supported predecessor masters and status model.</small><i class="material-symbols-outlined" aria-hidden="true">handyman</i></a>
    </div>
  </section>
  ...
  <section class="research-canvas__inventory" id="balances" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="https://help.sap.com/S4_CE_MO" target="_blank" rel="noopener"><span>AR</span><strong>Accounts Receivable open items</strong><small>Customer open receivables at cutover. Reconcile count, currency, amount, due-date logic, tax and migration clearing accounts.</small><i class="material-symbols-outlined" aria-hidden="true">payments</i></a>
      <a href="https://help.sap.com/S4_CE_MO" target="_blank" rel="noopener"><span>AP</span><strong>Accounts Payable open items</strong><small>Supplier liabilities that remain open after go-live. Close as much noise as possible before extraction and define how partial payments, special G/L and local requirements are handled.</small><i class="material-symbols-outlined" aria-hidden="true">receipt</i></a>
