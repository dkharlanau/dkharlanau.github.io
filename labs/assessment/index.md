...
description: "A practical assessment route for SAP Lead preparation across Sales, Procurement and Logistics, Integration, AI, data, diagnostics, and architecture decisions."
...
<div class="research-canvas">
  <header class="research-canvas__hero" data-reveal>
    ...
    <div class="research-canvas__signal" aria-label="Assessment route status">
      ...
      <div class="research-canvas__signal-line"><span>03</span><strong>16</strong><small>Structured practice cases</small></div>
      <em>Draft route. It uses existing Lab material and marks missing coverage instead of hiding it.</em>
    </div>
  </header>
  ...
  <section class="research-canvas__boundary" data-reveal>
    ...
    <p><strong>Assessment rule:</strong> when a result is wrong, find the first wrong decision. Do not repair the final document before you understand why it received that value.</p>
  ...
  <section class="research-canvas__inventory" id="reasoning-levels" data-reveal>
    <header>
      <p class="research-canvas__eyebrow">Reasoning levels</p>
      <h2>Move from knowledge to ownership.</h2>
      <p>The same topic can be tested at five levels. This makes practice harder without changing the subject every time.</p>
    </header>
    <div class="research-route-list">
      <a href="#assessment-tracks"><span>01</span><strong>Explain</strong><small>Describe the business purpose, main objects, process flow, and system boundary in clear language.</small><i class="material-symbols-outlined" aria-hidden="true">record_voice_over</i></a>
      <a href="#assessment-tracks"><span>02</span><strong>Trace</strong><small>Follow one business requirement through master data, configuration, documents, integration, and accounting impact.</small><i class="material-symbols-outlined" aria-hidden="true">route</i></a>
      <a href="#assessment-tracks"><span>03</span><strong>Diagnose</strong><small>Start from a symptom, build competing hypotheses, find the first wrong decision, and define evidence for the fix.</small><i class="material-symbols-outlined" aria-hidden="true">troubleshoot</i></a>
      ...
      <a href="#assessment-tracks"><span>05</span><strong>Challenge</strong><small>Explain trade-offs, limits, failure modes, alternative designs, and what would make you change the decision.</small><i class="material-symbols-outlined" aria-hidden="true">balance</i></a>
    </div>
  </section>
  ...
  <section class="research-canvas__inventory" id="assessment-tracks" data-reveal>
    <header>
      ...
      <p>Start with the sales process, then move into the engines that decide item behavior, price, confirmation, credit, delivery, tax, and downstream execution.</p>
    </header>
    <div class="research-route-list">
      <a href="/labs/enterprise-context/sales-processes/"><span>MAP</span><strong>Sales Process Atlas</strong><small>Core and special sales scenarios, process variants, document chains, controls, and integration points.</small><i class="material-symbols-outlined" aria-hidden="true">route</i></a>
      <a href="/labs/enterprise-context/sales-order/"><span>SO</span><strong>Sales Order Decision Map</strong><small>Trace how master data, determinations, rules, partner data, dates, and document controls shape the order.</small><i class="material-symbols-outlined" aria-hidden="true">account_tree</i></a>
      ...
      <a href="/labs/enterprise-context/shipping/"><span>SHP</span><strong>Shipping and Scheduling</strong><small>Shipping point, route, scheduling, delivery due logic, splits, EWM and TM boundaries.</small><i class="material-symbols-outlined" aria-hidden="true">local_shipping</i></a>
      <a href="/labs/enterprise-context/sales-diagnostics/"><span>CASE</span><strong>Sales Diagnostic Casebook</strong><small>Symptom-first investigation, hypotheses, ownership boundaries, evidence packages, and proof of fix.</small><i class="material-symbols-outlined" aria-hidden="true">troubleshoot</i></a>
    </div>
  </section>

  <section class="research-canvas__inventory" data-reveal>
    <header>
      <p class="research-canvas__eyebrow">Track 02 / Procurement and Logistics</p>
      <h2>Follow demand until physical and financial completion.</h2>
      <p>A Lead should separate demand, sourcing, purchasing, inventory, warehouse execution, transportation, invoice verification, and settlement instead of treating them as one large MM topic.</p>
    </header>
    <div class="research-route-list">
      ...
      <a href="/labs/enterprise-context/condition-contract-management/"><span>CCM</span><strong>Condition Contract Management</strong><small>Settlement logic across sales and procurement, conditions, business volume, accruals, and contract boundaries.</small><i class="material-symbols-outlined" aria-hidden="true">contract</i></a>
      <a href="/labs/enterprise-context/logistics-capabilities/"><span>X</span><strong>Cross-Process Logistics Capabilities</strong><small>Shared logistics concepts such as batch, handling units, serials, packaging, and cross-process ownership.</small><i class="material-symbols-outlined" aria-hidden="true">hub</i></a>
    </div>
  </section>
  ...
  <section class="research-canvas__inventory" data-reveal>
    <header>
      ...
      <p>The useful question is not only “IDoc or API?”. It is who owns the state, how the message is identified, how retries work, how duplicates are handled, and how operations prove business completion.</p>
    </header>
    <div class="research-route-list">
      ...
      <a href="/labs/enterprise-context/sales-processes/integrations/"><span>SD</span><strong>Sales Integration Map</strong><small>Order, delivery, billing-adjacent, partner, warehouse, transport, and external sales handoffs.</small><i class="material-symbols-outlined" aria-hidden="true">sync_alt</i></a>
      <a href="/labs/enterprise-context/transportation-management/integrations/"><span>TM</span><strong>TM Integration Contracts</strong><small>ERP demand, APIs, B2B messages, execution events, communication scenarios, and business events.</small><i class="material-symbols-outlined" aria-hidden="true">sync</i></a>
      <a href="/labs/enterprise-context/mdg/interfaces/"><span>MDG</span><strong>Master Data Distribution</strong><small>Governance ownership, replication, interface boundaries, data quality, and downstream consequences.</small><i class="material-symbols-outlined" aria-hidden="true">account_tree</i></a>
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="/labs/enterprise-context/mdg/"><span>MDG</span><strong>Master Data Governance</strong><small>Data ownership, governance process, architecture, deployment, interfaces, extensions, and logistics impact.</small><i class="material-symbols-outlined" aria-hidden="true">verified</i></a>
  ...
  <section class="research-canvas__method" data-reveal>
    ...
    <ol>
      ...
      <li><span>05</span><strong>Boundary</strong><p>Show the integration, extension, warehouse, finance, or AI handoff.</p></li>
  ...
  <section class="research-canvas__inventory" id="coverage" data-reveal>
    <header>
      ...
      <p>The route should show missing coverage. A hidden gap is much more dangerous than a visible backlog.</p>
    </header>
    <div class="ecg-decision-columns">
      <div>
        <h4>Strong now</h4>
        <ul>
          <li>Sales processes, sales order decisions, pricing, ATP, credit, shipping, tax, diagnostics</li>
          <li>Procurement, EWM, TM, logistics capabilities</li>
          <li>Integration architecture, development choices, deployment models</li>
          <li>MDG, Business AI, AI system architecture</li>
        </ul>
      </div>
      <div>
        <h4>Next verticals</h4>
        <ul>
          ...
          <li>FI/CO touchpoints for logistics</li>
          <li>Automotive JIT / JIS</li>
        </ul>
      </div>
      <div>
        <h4>Next practice layer</h4>
        <ul>
          <li>Cross-process end-to-end cases</li>
          <li>Integration operations and recovery</li>
          <li>Assessment scoring and weak-signal tracking</li>
          <li>Question generation from graph relationships</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="research-canvas__inventory" data-reveal>
    <header>
      <p class="research-canvas__eyebrow">Practice cases</p>
      <h2>Questions should force a reasoning path.</h2>
      <p>The first dataset contains cases across process explanation, diagnostics, architecture, integration, data, and AI. Each case includes expected points, follow-up questions, red flags, and links back to Lab material.</p>
    </header>
    <div class="research-route-list">
      <a href="/labs/assessment/data/cases.jsonl"><span>CASE</span><strong>Structured assessment cases</strong><small>16 JSONL cases for mock interviews, agent evaluation, retrieval, and answer scoring.</small><i class="material-symbols-outlined" aria-hidden="true">fact_check</i></a>
      <a href="/labs/assessment/data/catalog.json"><span>JSON</span><strong>Assessment catalog</strong><small>Tracks, reasoning levels, endpoints, current coverage, and next build areas.</small><i class="material-symbols-outlined" aria-hidden="true">data_object</i></a>
    </div>
  </section>
