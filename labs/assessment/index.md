...
<div class="research-canvas">
  ...
  <section class="research-canvas__inventory" id="assessment-tracks" data-reveal>
    ...
    <div class="research-route-list">
      <a href="/labs/assessment/sales/"><span>LEAD</span><strong>Sales Lead Assessment Map</strong><small>20-minute refresh, 60-minute assessment pass, and 30-second / 2-minute / scenario answer frames.</small><i class="material-symbols-outlined" aria-hidden="true">record_voice_over</i></a>
      ...
      <a href="/labs/enterprise-context/sales-processes/integrations/"><span>INT</span><strong>Sales Integration Map</strong><small>Business contract, IDoc/API/event choice, sync/async behavior, ownership, recovery, and cross-application handoffs.</small><i class="material-symbols-outlined" aria-hidden="true">hub</i></a>
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="ecg-decision-columns">
      ...
      <div><h3>Practice layer</h3><ul><li>78 structured cases</li><li>Adaptive single-case selection</li><li>Balanced mock sessions</li><li>Weak-signal review queue</li><li>Shared seven-dimension scoring history</li><li>Portable local history import and export</li><li>Provenance-aware feedback evidence</li></ul></div>
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="/labs/assessment/data/case-sets.json"><span>SET</span><strong>Case Set Manifest</strong><small>78 cases across core and specialist datasets.</small><i class="material-symbols-outlined" aria-hidden="true">dataset</i></a>
