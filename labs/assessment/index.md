...
<div class="research-canvas">
  <header class="research-canvas__hero" data-reveal>
    ...
    <div class="research-canvas__signal" aria-label="Assessment route status">
      ...
      <div class="research-canvas__signal-line"><span>03</span><strong>72</strong><small>Structured practice cases</small></div>
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="ecg-decision-columns">
      ...
      <div><h3>Practice layer</h3><ul><li>72 structured cases</li><li>Adaptive single-case selection</li><li>Balanced mock sessions</li><li>Weak-signal review queue</li><li>Shared seven-dimension scoring history</li><li>Portable local history import and export</li><li>Provenance-aware feedback evidence</li></ul></div>
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="/labs/assessment/data/case-sets.json"><span>SET</span><strong>Case Set Manifest</strong><small>72 cases across core and specialist datasets.</small><i class="material-symbols-outlined" aria-hidden="true">dataset</i></a>
