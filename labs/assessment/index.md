...
<div class="research-canvas">
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="/labs/assessment/data/backlog.json"><span>LOOP</span><strong>Development State</strong><small>LOOP-001 through LOOP-020 are complete; twelve core SAP routes now have claim-level primary-source review.</small><i class="material-symbols-outlined" aria-hidden="true">playlist_add_check</i></a>
    </div>
  </section>
