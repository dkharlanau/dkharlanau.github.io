...
<section class="section atlas-hero">
  ...
  <h1>Master data, quality signals, and operational failure modes.</h1>
  <p class="lead">This section connects SAP support symptoms to the data objects and governance decisions that often create them: business partners, suppliers, materials, process ownership, migration history, and quality rules.</p>
</section>

<section class="section"><header class="section-heading"><p class="eyebrow">Curated Pages</p><h2>Data quality topics</h2></header><div class="atlas-card-grid">
