...
def main() -> int:
    ...
    landing = (
        ...
        f"    <p>License: <a href=\"{DATA_LICENSE_URL}\" target=\"_blank\" rel=\"noopener noreferrer\">{DATA_LICENSE_NAME}</a> (non-commercial only, attribution with source link required).</p>\n"
