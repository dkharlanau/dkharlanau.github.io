...
description: "Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems"
permalink: /datasets/view/LLM-prompts/CE-04/
sitemap: true
...
<div class="dataset-hero">
  ...
  <h1 class="dataset-hero__title">Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems</h1>
  <div class="dataset-hero__meta">
    <span class="pill pill--dataset">LLM-prompts</span>
    <span class="pill pill--type">llm_prompt_byte</span>
    <span class="pill">CE-04</span>
  </div>
  <div class="dataset-actions">
    <a class="button" href="/datasets/LLM-prompts/CE-04.json">Open JSON</a>
    <a class="button button--secondary" href="/datasets/LLM-prompts/">Back to list</a>
  </div>
</div>

<div class="neub-card dataset-entry-lead">Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems</div>

<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    <h2>License &amp; citation</h2>
    <p>Creator: <strong>Dzmitryi Kharlanau</strong> (SAP Lead).</p>
    <p>Canonical: <a href="https://dkharlanau.github.io/datasets/LLM-prompts/CE-04.json">https://dkharlanau.github.io/datasets/LLM-prompts/CE-04.json</a></p>
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-04.json</p>
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems",
  "description": "Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems",
  "url": "https://dkharlanau.github.io/datasets/view/LLM-prompts/CE-04/",
  "isAccessibleForFree": true,
  "license": "https://creativecommons.org/licenses/by-nc/4.0/",
  "citation": "Dzmitryi Kharlanau. “Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-04.json",
  ...
  "distribution": [
    {
      ...
      "contentUrl": "https://dkharlanau.github.io/datasets/LLM-prompts/CE-04.json"
    }
  ]
}
</script>
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “Prompt Optimization as Engineering: From Handcrafted Prompts to Optimized Systems” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-04.json"
    },
    "license": {
