...
description: "Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control"
permalink: /datasets/view/LLM-prompts/CE-03/
sitemap: true
---

<div class="dataset-hero">
  <p class="eyebrow">Dataset entry</p>
  <h1 class="dataset-hero__title">Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control</h1>
  <div class="dataset-hero__meta">
    <span class="pill pill--dataset">LLM-prompts</span>
    <span class="pill pill--type">llm_prompt_byte</span>
    <span class="pill">CE-03</span>
  </div>
  <div class="dataset-actions">
    <a class="button" href="/datasets/LLM-prompts/CE-03.json">Open JSON</a>
    <a class="button button--secondary" href="/datasets/LLM-prompts/">Back to list</a>
  </div>
</div>

<div class="neub-card dataset-entry-lead">Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control</div>

<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    <h2>License &amp; citation</h2>
    <p>Creator: <strong>Dzmitryi Kharlanau</strong> (SAP Lead).</p>
    <p>Canonical: <a href="https://dkharlanau.github.io/datasets/LLM-prompts/CE-03.json">https://dkharlanau.github.io/datasets/LLM-prompts/CE-03.json</a></p>
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-03.json</p>
...
<script type="application/ld+json">
{
  ...
  "description": "Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control",
  "url": "https://dkharlanau.github.io/datasets/view/LLM-prompts/CE-03/",
  "isAccessibleForFree": true,
  "license": "https://creativecommons.org/licenses/by-nc/4.0/",
  "citation": "Dzmitryi Kharlanau. “Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-03.json",
  ...
  "distribution": [
    {
      ...
      "contentUrl": "https://dkharlanau.github.io/datasets/LLM-prompts/CE-03.json"
    }
  ]
}
</script>
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “Retrieval as a Product: RAG Refinement, Compression, and Long-Context Noise Control” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-03.json"
    },
    "license": {
