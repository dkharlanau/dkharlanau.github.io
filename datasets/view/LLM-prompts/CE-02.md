...
<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Positional Strategy: Engineering Around &#x27;Lost in the Middle&#x27; in Long Context + RAG” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-02.json</p>
...
<script type="application/ld+json">
{
  ...
  "citation": "Dzmitryi Kharlanau. “Positional Strategy: Engineering Around 'Lost in the Middle' in Long Context + RAG” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-02.json",
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “Positional Strategy: Engineering Around 'Lost in the Middle' in Long Context + RAG” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/LLM-prompts/CE-02.json"
    },
    "license": {
