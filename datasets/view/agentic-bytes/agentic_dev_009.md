...
<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Plan → Execute: Separating Thinking from Doing” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/agentic-bytes/agentic_dev_009.json</p>
...
<script type="application/ld+json">
{
  ...
  "citation": "Dzmitryi Kharlanau. “Plan → Execute: Separating Thinking from Doing” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/agentic-bytes/agentic_dev_009.json",
