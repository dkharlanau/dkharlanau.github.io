...
<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Single-Agent vs Multi-Agent: When One Brain Is Enough” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/agentic-bytes/agentic_dev_018.json</p>
...
<script type="application/ld+json">
{
  ...
  "citation": "Dzmitryi Kharlanau. “Single-Agent vs Multi-Agent: When One Brain Is Enough” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/agentic-bytes/agentic_dev_018.json",
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “Single-Agent vs Multi-Agent: When One Brain Is Enough” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/agentic-bytes/agentic_dev_018.json"
    },
    "license": {
