...
<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Governance Drift: How to detect degradation early and respond without panic fixes” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/DAMA/db_governance_drift_detection_response_v0_1.json</p>
...
<script type="application/ld+json">
{
  ...
  "citation": "Dzmitryi Kharlanau. “Governance Drift: How to detect degradation early and respond without panic fixes” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/DAMA/db_governance_drift_detection_response_v0_1.json",
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “Governance Drift: How to detect degradation early and respond without panic fixes” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/DAMA/db_governance_drift_detection_response_v0_1.json"
    },
    "license": {
