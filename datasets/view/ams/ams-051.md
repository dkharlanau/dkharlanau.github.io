...
description: "Classic SAP documentation dies the moment reality changes. Diagrams freeze assumptions. Text structures evolve."
permalink: /datasets/view/ams/ams-051/
sitemap: true
---

<div class="dataset-hero">
  <p class="eyebrow">Dataset entry</p>
  <h1 class="dataset-hero__title">RAG-First Documentation: From Diagrams to Living Text Structures</h1>
  <div class="dataset-hero__meta">
    <span class="pill pill--dataset">ams</span>
    <span class="pill pill--type">ams_byte</span>
    <span class="pill">ams-051</span>
  </div>
  <div class="dataset-actions">
    <a class="button" href="/datasets/ams/ams-051.json">Open JSON</a>
    <a class="button button--secondary" href="/datasets/ams/">Back to list</a>
  </div>
</div>

<div class="neub-card dataset-entry-lead">Classic SAP documentation dies the moment reality changes. Diagrams freeze assumptions. Text structures evolve.</div>

<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    <h2>License &amp; citation</h2>
    <p>Creator: <strong>Dzmitryi Kharlanau</strong> (SAP Lead).</p>
    <p>Canonical: <a href="https://dkharlanau.github.io/datasets/ams/ams-051.json">https://dkharlanau.github.io/datasets/ams/ams-051.json</a></p>
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “RAG-First Documentation: From Diagrams to Living Text Structures” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-051.json</p>
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "RAG-First Documentation: From Diagrams to Living Text Structures",
  "description": "Classic SAP documentation dies the moment reality changes. Diagrams freeze assumptions. Text structures evolve.",
  "url": "https://dkharlanau.github.io/datasets/view/ams/ams-051/",
  "isAccessibleForFree": true,
  "license": "https://creativecommons.org/licenses/by-nc/4.0/",
  "citation": "Dzmitryi Kharlanau. “RAG-First Documentation: From Diagrams to Living Text Structures” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-051.json",
  ...
  "distribution": [
    {
      ...
      "contentUrl": "https://dkharlanau.github.io/datasets/ams/ams-051.json"
    }
  ]
}
</script>
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “RAG-First Documentation: From Diagrams to Living Text Structures” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-051.json"
    },
    "license": {
