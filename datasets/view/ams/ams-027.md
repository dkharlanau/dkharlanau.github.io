...
description: "SAP AMS usually drowns not because of too many incidents, but because Problems and Changes fight for the same oxygen — and Problems always lose."
permalink: /datasets/view/ams/ams-027/
sitemap: true
---

<div class="dataset-hero">
  <p class="eyebrow">Dataset entry</p>
  <h1 class="dataset-hero__title">Problem vs Change Portfolio: Stop Letting Changes Starve Prevention</h1>
  <div class="dataset-hero__meta">
    <span class="pill pill--dataset">ams</span>
    <span class="pill pill--type">ams_byte</span>
    <span class="pill">ams-027</span>
  </div>
  <div class="dataset-actions">
    <a class="button" href="/datasets/ams/ams-027.json">Open JSON</a>
    <a class="button button--secondary" href="/datasets/ams/">Back to list</a>
  </div>
</div>

<div class="neub-card dataset-entry-lead">SAP AMS usually drowns not because of too many incidents, but because Problems and Changes fight for the same oxygen — and Problems always lose.</div>

<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    <h2>License &amp; citation</h2>
    <p>Creator: <strong>Dzmitryi Kharlanau</strong> (SAP Lead).</p>
    <p>Canonical: <a href="https://dkharlanau.github.io/datasets/ams/ams-027.json">https://dkharlanau.github.io/datasets/ams/ams-027.json</a></p>
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “Problem vs Change Portfolio: Stop Letting Changes Starve Prevention” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-027.json</p>
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "Problem vs Change Portfolio: Stop Letting Changes Starve Prevention",
  "description": "SAP AMS usually drowns not because of too many incidents, but because Problems and Changes fight for the same oxygen — and Problems always lose.",
  "url": "https://dkharlanau.github.io/datasets/view/ams/ams-027/",
  "isAccessibleForFree": true,
  "license": "https://creativecommons.org/licenses/by-nc/4.0/",
  "citation": "Dzmitryi Kharlanau. “Problem vs Change Portfolio: Stop Letting Changes Starve Prevention” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-027.json",
  ...
  "distribution": [
    {
      ...
      "contentUrl": "https://dkharlanau.github.io/datasets/ams/ams-027.json"
    }
  ]
}
</script>
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “Problem vs Change Portfolio: Stop Letting Changes Starve Prevention” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-027.json"
    },
    "license": {
