...
description: "Most SAP AMS teams believe they are mature because systems are running. Real maturity starts when the system improves itself."
permalink: /datasets/view/ams/ams-048/
sitemap: true
...
<div class="dataset-hero">
  ...
  <h1 class="dataset-hero__title">AMS Maturity Levels: From Firefighting to Decision Platform</h1>
  <div class="dataset-hero__meta">
    <span class="pill pill--dataset">ams</span>
    <span class="pill pill--type">ams_byte</span>
    <span class="pill">ams-048</span>
  </div>
  <div class="dataset-actions">
    <a class="button" href="/datasets/ams/ams-048.json">Open JSON</a>
    <a class="button button--secondary" href="/datasets/ams/">Back to list</a>
  </div>
</div>

<div class="neub-card dataset-entry-lead">Most SAP AMS teams believe they are mature because systems are running. Real maturity starts when the system improves itself.</div>

<div class="dataset-grid dataset-grid--wide">
  <div class="neub-card">
    <h2>License &amp; citation</h2>
    <p>Creator: <strong>Dzmitryi Kharlanau</strong> (SAP Lead).</p>
    <p>Canonical: <a href="https://dkharlanau.github.io/datasets/ams/ams-048.json">https://dkharlanau.github.io/datasets/ams/ams-048.json</a></p>
    ...
    <p>Suggested citation: Dzmitryi Kharlanau. “AMS Maturity Levels: From Firefighting to Decision Platform” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-048.json</p>
...
<script type="application/ld+json">
{
  ...
  "@type": "Dataset",
  "name": "AMS Maturity Levels: From Firefighting to Decision Platform",
  "description": "Most SAP AMS teams believe they are mature because systems are running. Real maturity starts when the system improves itself.",
  "url": "https://dkharlanau.github.io/datasets/view/ams/ams-048/",
  "isAccessibleForFree": true,
  "license": "https://creativecommons.org/licenses/by-nc/4.0/",
  "citation": "Dzmitryi Kharlanau. “AMS Maturity Levels: From Firefighting to Decision Platform” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-048.json",
  ...
  "distribution": [
    {
      ...
      "contentUrl": "https://dkharlanau.github.io/datasets/ams/ams-048.json"
    }
  ]
}
</script>
...
<pre><code class="language-json">{
  ...
  "meta": {
    ...
    "attribution": {
      ...
      "preferred_citation": "Dzmitryi Kharlanau. “AMS Maturity Levels: From Firefighting to Decision Platform” (dataset bytes). CC BY-NC 4.0. DOI: 10.5281/zenodo.18862098. https://dkharlanau.github.io/datasets/ams/ams-048.json"
    },
    "license": {
