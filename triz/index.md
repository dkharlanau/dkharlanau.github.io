...
<div class="research-canvas">
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="research-route-list">
      <a href="/triz/drill/"><span>90S</span><strong>SAP Lead assessment drill</strong><small>Eighteen timed Sales, Procurement, Logistics, Integration, Master Data, and AI cases with a 24-point Lead rubric and agent evaluation payload.</small><i class="material-symbols-outlined" aria-hidden="true">timer</i></a>
  ...
  <section class="research-canvas__inventory" data-reveal>
    ...
    <div class="research-route-list">
      ...
      <a href="/datasets/triz-digital-framework/decision-map.json"><span>MAP</span><strong>Decision routing map</strong><small>Contradiction types mapped to operators, patterns, resource focus, system-shape prompts, and metric pairs.</small><i class="material-symbols-outlined" aria-hidden="true">route</i></a>
      <a href="/datasets/triz-digital-framework/workbench-presets.json"><span>PRE</span><strong>Workbench presets</strong><small>Synthetic SAP Sales, Procurement, master-data, integration, process, and AI-agent problem frames.</small><i class="material-symbols-outlined" aria-hidden="true">tune</i></a>
      <a href="/datasets/triz-digital-framework/drill-cases.json"><span>18</span><strong>SAP Lead drill cases</strong><small>Synthetic assessment cases with contradiction, operators, system shapes, authority, evidence, metrics, red flags, and Lead signals.</small><i class="material-symbols-outlined" aria-hidden="true">quiz</i></a>
      <a href="/datasets/triz-digital-framework/lead-rubric.json"><span>24</span><strong>Lead scoring rubric</strong><small>Six dimensions, scoring anchors, performance bands, hard-fail signals, and the 60–90 second answer spine.</small><i class="material-symbols-outlined" aria-hidden="true">fact_check</i></a>
