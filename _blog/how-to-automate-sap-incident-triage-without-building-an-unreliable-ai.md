---
layout: blog
title: "How to Automate SAP Incident Triage Without Building an Unreliable AI Agent"
description: "An AI agent reads the ticket, searches previous incidents and decides that the problem is related to master data."
...
tags:
  ...
  - automation
  - ai-operations
canonical_url: https://dkharlanau.github.io/blog/how-to-automate-sap-incident-triage-without-building-an-unreliable-ai/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 26
migration_sequence: 14
...
- [What incident triage should achieve](#what-incident-triage-should-achieve)
- [Why normal ticket routing fails](#why-normal-ticket-routing-fails)
- [The unreliable-agent approach](#the-unreliable-agent-approach)
- [Build a triage pipeline, not one agent](#build-a-triage-pipeline-not-one-agent)
- [Stage 1: Intake validation](#stage-1-intake-validation)
- [Stage 2: Context enrichment](#stage-2-context-enrichment)
- [Stage 3: Signal correlation](#stage-3-signal-correlation)
- [Stage 4: Business-impact estimation](#stage-4-business-impact-estimation)
- [Stage 5: Known-pattern matching](#stage-5-known-pattern-matching)
- [Stage 6: Ownership recommendation](#stage-6-ownership-recommendation)
- [Stage 7: Human acceptance](#stage-7-human-acceptance)
- [Stage 8: Continuous feedback](#stage-8-continuous-feedback)
- [Stage 1: Validate the incident intake](#stage-1-validate-the-incident-intake)
- [Do not block urgent incidents](#do-not-block-urgent-incidents)
- [Stage 2: Add context automatically](#stage-2-add-context-automatically)
- [Use business-service context](#use-business-service-context)
- [Stage 3: Correlate technical signals](#stage-3-correlate-technical-signals)
- [Correlation is not causation](#correlation-is-not-causation)
- [Stage 4: Estimate business impact](#stage-4-estimate-business-impact)
- [Use evidence-based priority](#use-evidence-based-priority)
- [Stage 5: Match verified patterns](#stage-5-match-verified-patterns)
- [Collection 1: Verified known errors](#collection-1-verified-known-errors)
- [Collection 2: Historical incidents](#collection-2-historical-incidents)
- [Similarity should explain itself](#similarity-should-explain-itself)
- [Stage 6: Recommend ownership](#stage-6-recommend-ownership)
- [Route to the first qualified owner, not the final root-cause owner](#route-to-the-first-qualified-owner-not-the-final-root-cause-owner)
- [Keep service ownership stable](#keep-service-ownership-stable)
- [Stage 7: Require human acceptance at first](#stage-7-require-human-acceptance-at-first)
- [Do not ask humans to approve blindly](#do-not-ask-humans-to-approve-blindly)
- [Stage 8: Learn from verified outcomes](#stage-8-learn-from-verified-outcomes)
- [Build a controlled feedback process](#build-a-controlled-feedback-process)
- [A reference triage architecture](#a-reference-triage-architecture)
- [Intake layer](#intake-layer)
- [Normalization layer](#normalization-layer)
- [Context layer](#context-layer)
- [Observability layer](#observability-layer)
- [Reasoning layer](#reasoning-layer)
- [Control layer](#control-layer)
- [Service-management layer](#service-management-layer)
- [Feedback layer](#feedback-layer)
- [Where deterministic rules should lead](#where-deterministic-rules-should-lead)
- [Where AI is useful](#where-ai-is-useful)
- [Use structured outputs](#use-structured-outputs)
- [Confidence should be field-specific](#confidence-should-be-field-specific)
- [Define abstention rules](#define-abstention-rules)
- [Suggested confidence thresholds](#suggested-confidence-thresholds)
- [Test with difficult incidents](#test-with-difficult-incidents)
- [Build an evaluation dataset](#build-an-evaluation-dataset)
- [Measure more than classification accuracy](#measure-more-than-classification-accuracy)
- [False confidence is more dangerous than low coverage](#false-confidence-is-more-dangerous-than-low-coverage)
- [Separate triage from diagnosis](#separate-triage-from-diagnosis)
- [Separate diagnosis from recovery](#separate-diagnosis-from-recovery)
- [A sensible autonomy roadmap](#a-sensible-autonomy-roadmap)
- [Phase 1: Assistance](#phase-1-assistance)
- [Phase 2: Stable automatic routing](#phase-2-stable-automatic-routing)
- [Phase 3: Coordinated response](#phase-3-coordinated-response)
- [Phase 4: Narrow guarded recovery](#phase-4-narrow-guarded-recovery)
- [Use workflows around agents](#use-workflows-around-agents)
- [Protect sensitive incident data](#protect-sensitive-incident-data)
- [Prevent cross-service data leakage](#prevent-cross-service-data-leakage)
- [Keep a complete decision trace](#keep-a-complete-decision-trace)
- [Monitor drift](#monitor-drift)
- [The service catalogue is more important than the model](#the-service-catalogue-is-more-important-than-the-model)
- [The knowledge base must separate truth levels](#the-knowledge-base-must-separate-truth-levels)
- [A practical first implementation](#a-practical-first-implementation)
- [Example triage output](#example-triage-output)
- [Common implementation mistakes](#common-implementation-mistakes)
- [Mistake 1: Training on ticket categories only](#mistake-1-training-on-ticket-categories-only)
- [Mistake 2: Hiding uncertainty](#mistake-2-hiding-uncertainty)
- [Mistake 3: Giving execution rights too early](#mistake-3-giving-execution-rights-too-early)
- [Mistake 4: Using outdated ownership data](#mistake-4-using-outdated-ownership-data)
- [Mistake 5: Measuring only automation rate](#mistake-5-measuring-only-automation-rate)
- [Mistake 6: Treating every previous incident as trusted knowledge](#mistake-6-treating-every-previous-incident-as-trusted-knowledge)
- [Mistake 7: Building one universal prompt](#mistake-7-building-one-universal-prompt)
- [Mistake 8: Ignoring business-service ownership](#mistake-8-ignoring-business-service-ownership)
- [Mistake 9: Automating a broken intake process](#mistake-9-automating-a-broken-intake-process)
- [Mistake 10: Removing human analysts too early](#mistake-10-removing-human-analysts-too-early)
...
- Previous in the migration: [15 SAP AMS Tasks That Should Be Automated — and 10 That Should Not](/blog/15-sap-ams-tasks-that-should-be-automated-and-10-that-should-not/)
- Next in the migration: [How to Automate SAP Interface Monitoring and Recovery Without Creating Duplicate Transactions](/blog/how-to-automate-sap-interface-monitoring-and-recovery-without-creating/)
