---
layout: blog
title: "SAP EWM Explained: Processes, Integrations, Deployment Choices, and the Limitations Nobody Should Ignore"
description: "inbound deliveries; - putaway; - picking; - packing; - waves; - radio-frequency transactions; - warehouse monitoring."
slug: sap-ewm-explained-processes-integrations-deployment-choices-and-the
permalink: /blog/sap-ewm-explained-processes-integrations-deployment-choices-and-the/
date: 2026-07-17
...
tags:
  ...
  - ai-operations
  - integration
canonical_url: https://dkharlanau.github.io/blog/sap-ewm-explained-processes-integrations-deployment-choices-and-the/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 47
migration_sequence: 45
...
- [What SAP EWM actually does](#what-sap-ewm-actually-does)
- [What EWM does not do](#what-ewm-does-not-do)
- [Inventory Management versus Warehouse Management](#inventory-management-versus-warehouse-management)
- [Deployment options](#deployment-options)
- [Embedded EWM](#embedded-ewm)
- [Basic embedded EWM](#basic-embedded-ewm)
- [Advanced embedded EWM](#advanced-embedded-ewm)
- [Decentralized EWM](#decentralized-ewm)
- [Embedded versus decentralized](#embedded-versus-decentralized)
- [The EWM organizational structure](#the-ewm-organizational-structure)
- [Plant and storage location](#plant-and-storage-location)
...
- [Door and staging area](#door-and-staging-area)
- [Yard](#yard)
- [Core master data](#core-master-data)
- [Product master](#product-master)
- [Packaging specification](#packaging-specification)
- [Handling unit](#handling-unit)
- [Batch](#batch)
- [Serial number](#serial-number)
- [Catch weight and stock-specific units](#catch-weight-and-stock-specific-units)
- [Resource](#resource)
- [Warehouse process type](#warehouse-process-type)
- [Warehouse document model](#warehouse-document-model)
- [Business document](#business-document)
- [Delivery document](#delivery-document)
- [EWM warehouse request](#ewm-warehouse-request)
- [Warehouse task](#warehouse-task)
- [Warehouse order](#warehouse-order)
- [Physical confirmation](#physical-confirmation)
- [Inbound process](#inbound-process)
- [Purchase order and inbound delivery](#purchase-order-and-inbound-delivery)
- [Advance shipping notification](#advance-shipping-notification)
- [Appointment and check-in](#appointment-and-check-in)
- [Unloading](#unloading)
- [Goods receipt timing](#goods-receipt-timing)
- [Deconsolidation](#deconsolidation)
- [Quality inspection](#quality-inspection)
- [Value-added services](#value-added-services)
- [Putaway](#putaway)
- [Storage control](#storage-control)
- [Direct putaway](#direct-putaway)
- [Cross-docking](#cross-docking)
- [Inbound limitations](#inbound-limitations)
- [Internal warehouse processes](#internal-warehouse-processes)
- [Ad hoc movement](#ad-hoc-movement)
- [Posting change](#posting-change)
...
- [Sales order and scheduling](#sales-order-and-scheduling)
- [Outbound delivery](#outbound-delivery)
- [Delivery split](#delivery-split)
- [Wave management](#wave-management)
- [Warehouse-order creation](#warehouse-order-creation)
- [Picking strategies](#picking-strategies)
- [Stock-removal strategy](#stock-removal-strategy)
...
- [Outbound limitations](#outbound-limitations)
- [Production integration](#production-integration)
- [Planning versus execution](#planning-versus-execution)
...
- [Production-integration limitations](#production-integration-limitations)
- [Quality integration](#quality-integration)
- [Physical and logical control](#physical-and-logical-control)
- [Quality timing options](#quality-timing-options)
- [Quality limitations](#quality-limitations)
- [Transportation Management integration](#transportation-management-integration)
- [Core relationship](#core-relationship)
- [Information from TM to EWM](#information-from-tm-to-ewm)
- [Information from EWM to TM](#information-from-ewm-to-tm)
- [Scheduling alignment](#scheduling-alignment)
- [Delivery-based integration](#delivery-based-integration)
- [Advanced shipping and receiving](#advanced-shipping-and-receiving)
- [Transportation unit](#transportation-unit)
- [Dock appointment](#dock-appointment)
- [TM-integration limitations](#tm-integration-limitations)
- [Yard management](#yard-management)
- [EWM yard management](#ewm-yard-management)
- [SAP Yard Logistics](#sap-yard-logistics)
- [Yard limitations](#yard-limitations)
- [Automation and Material Flow System](#automation-and-material-flow-system)
- [External WCS architecture](#external-wcs-architecture)
- [SAP MFS architecture](#sap-mfs-architecture)
- [Automation objects](#automation-objects)
- [Warehouse Robotics](#warehouse-robotics)
- [Automation limitations](#automation-limitations)
- [Exactly-once physical execution is difficult](#exactly-once-physical-execution-is-difficult)
- [Automation testing](#automation-testing)
- [Labour management and resource management](#labour-management-and-resource-management)
- [Resource management](#resource-management)
- [Labour management](#labour-management)
- [Limitation: productivity context](#limitation-productivity-context)
- [RF and mobile execution](#rf-and-mobile-execution)
- [RF limitations](#rf-limitations)
- [Voice and augmented reality](#voice-and-augmented-reality)
- [Retail and e-commerce processes](#retail-and-e-commerce-processes)
- [High order-line volume](#high-order-line-volume)
- [Order cancellation](#order-cancellation)
- [Returns](#returns)
- [Kitting and VAS](#kitting-and-vas)
- [Cross-docking models](#cross-docking-models)
- [Monitoring and exception management](#monitoring-and-exception-management)
- [Technical status versus business status](#technical-status-versus-business-status)
- [Exception codes](#exception-codes)
- [Warehouse control tower](#warehouse-control-tower)
- [Integration with S/4HANA Procurement](#integration-with-s-4hana-procurement)
- [Integration with S/4HANA Sales](#integration-with-s-4hana-sales)
- [Integration with stock transport orders](#integration-with-stock-transport-orders)
- [Integration with Business Network](#integration-with-business-network)
- [Integration with external OMS and Commerce](#integration-with-external-oms-and-commerce)
- [Integration with non-SAP ERP](#integration-with-non-sap-erp)
- [Integration with 3PL](#integration-with-3pl)
- [Integration mechanisms](#integration-mechanisms)
- [qRFC and queues](#qrfc-and-queues)
- [APIs and Integration Suite](#apis-and-integration-suite)
- [Events](#events)
- [Inventory synchronization and reconciliation](#inventory-synchronization-and-reconciliation)
- [Main limitations of SAP EWM](#main-limitations-of-sap-ewm)
- [Limitation 1: High configuration complexity](#limitation-1-high-configuration-complexity)
- [Limitation 2: Process design can become opaque](#limitation-2-process-design-can-become-opaque)
- [Limitation 3: Master-data sensitivity](#limitation-3-master-data-sensitivity)
- [Limitation 4: Real-time execution increases operational dependency](#limitation-4-real-time-execution-increases-operational-dependency)
- [Limitation 5: Limited offline operation](#limitation-5-limited-offline-operation)
- [Limitation 6: Embedded system coupling](#limitation-6-embedded-system-coupling)
- [Limitation 7: Decentralized integration complexity](#limitation-7-decentralized-integration-complexity)
- [Limitation 8: Automation lock-in](#limitation-8-automation-lock-in)
- [Limitation 9: Custom RF debt](#limitation-9-custom-rf-debt)
- [Limitation 10: Warehouse process can overrule business economics](#limitation-10-warehouse-process-can-overrule-business-economics)
- [Limitation 11: Waves can create artificial peaks](#limitation-11-waves-can-create-artificial-peaks)
- [Limitation 12: Labour standards can be misused](#limitation-12-labour-standards-can-be-misused)
- [Limitation 13: Stock accuracy remains physical](#limitation-13-stock-accuracy-remains-physical)
- [Limitation 14: Too much detail creates volume](#limitation-14-too-much-detail-creates-volume)
- [Limitation 15: Public-cloud scope is not identical](#limitation-15-public-cloud-scope-is-not-identical)
- [Limitation 16: EWM cannot stabilize upstream demand](#limitation-16-ewm-cannot-stabilize-upstream-demand)
- [Limitation 17: EWM cannot optimize transport cost alone](#limitation-17-ewm-cannot-optimize-transport-cost-alone)
- [Limitation 18: Implementation testing is physically expensive](#limitation-18-implementation-testing-is-physically-expensive)
- [Choosing whether EWM is needed](#choosing-whether-ewm-is-needed)
- [A practical target architecture](#a-practical-target-architecture)
- [Implementation approach](#implementation-approach)
- [Phase 1: Observe physical reality](#phase-1-observe-physical-reality)
- [Phase 2: Define warehouse archetypes](#phase-2-define-warehouse-archetypes)
- [Phase 3: Decide deployment](#phase-3-decide-deployment)
- [Phase 4: Design stock ownership](#phase-4-design-stock-ownership)
- [Phase 5: Build warehouse structure](#phase-5-build-warehouse-structure)
- [Phase 6: Design documents and states](#phase-6-design-documents-and-states)
- [Phase 7: Design master data](#phase-7-design-master-data)
- [Phase 8: Design exceptions](#phase-8-design-exceptions)
- [Phase 9: Integrate planning and transport](#phase-9-integrate-planning-and-transport)
- [Phase 10: Add automation selectively](#phase-10-add-automation-selectively)
- [Phase 11: Build reconciliation](#phase-11-build-reconciliation)
- [Phase 12: Test disruption](#phase-12-test-disruption)
- [Phase 13: Stabilize before optimizing](#phase-13-stabilize-before-optimizing)
...
- Previous in the migration: [Why SAP Retail Is Not Just SAP MM and SD: The Complete Architecture from Product Onboarding to Omnichannel Fulfilment](/blog/why-sap-retail-is-not-just-sap-mm-and-sd-the-complete-architecture-from/)
- Next in the migration: [How to Build AI Workflows Around SAP Without Creating a Second Uncontrolled ERP](/blog/how-to-build-ai-workflows-around-sap-without-creating-a-second/)
