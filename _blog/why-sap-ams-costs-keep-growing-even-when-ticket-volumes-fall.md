---
layout: blog
title: "Why SAP AMS Costs Keep Growing Even When Ticket Volumes Fall"
description: "SAP ticket volume is down by 18%. More incidents are resolved automatically. Users have better self-service instructions."
slug: why-sap-ams-costs-keep-growing-even-when-ticket-volumes-fall
permalink: /blog/why-sap-ams-costs-keep-growing-even-when-ticket-volumes-fall/
date: 2026-07-17
...
tags:
  - sap-ams-operations
  - sap-ams
canonical_url: https://dkharlanau.github.io/blog/why-sap-ams-costs-keep-growing-even-when-ticket-volumes-fall/
...
- [Ticket volume is a weak measure of support demand](#ticket-volume-is-a-weak-measure-of-support-demand)
- [Fewer tickets may simply mean that work moved elsewhere](#fewer-tickets-may-simply-mean-that-work-moved-elsewhere)
- [The main cost drivers of modern SAP AMS](#the-main-cost-drivers-of-modern-sap-ams)
- [1. Landscape complexity](#1-landscape-complexity)
- [2. Integration workload](#2-integration-workload)
- [3. Change volume](#3-change-volume)
- [4. Knowledge debt](#4-knowledge-debt)
- [5. Master data correction](#5-master-data-correction)
- [6. Manual operational controls](#6-manual-operational-controls)
- [7. Provider and ownership fragmentation](#7-provider-and-ownership-fragmentation)
- [8. Risk and compliance requirements](#8-risk-and-compliance-requirements)
- [Why automation does not create immediate savings](#why-automation-does-not-create-immediate-savings)
- [AI changes the cost structure, not only the cost level](#ai-changes-the-cost-structure-not-only-the-cost-level)
- [Cloud does not remove AMS](#cloud-does-not-remove-ams)
- [The problem with duplicated tools](#the-problem-with-duplicated-tools)
- [Fixed capacity can hide falling demand](#fixed-capacity-can-hide-falling-demand)
- [Low ticket volume can be a warning sign](#low-ticket-volume-can-be-a-warning-sign)
- [The difference between cost reduction and cost movement](#the-difference-between-cost-reduction-and-cost-movement)
- [A better SAP AMS cost model](#a-better-sap-ams-cost-model)
- [1. Service restoration cost](#1-service-restoration-cost)
- [2. Routine operations cost](#2-routine-operations-cost)
- [3. Change cost](#3-change-cost)
- [4. Complexity cost](#4-complexity-cost)
- [5. Risk cost](#5-risk-cost)
- [6. Improvement investment](#6-improvement-investment)
- [The cost of doing nothing](#the-cost-of-doing-nothing)
- [How managers should review SAP AMS cost](#how-managers-should-review-sap-ams-cost)
- [A practical method for finding hidden AMS cost](#a-practical-method-for-finding-hidden-ams-cost)
- [The correct goal is not the cheapest support team](#the-correct-goal-is-not-the-cheapest-support-team)
- [SAP AMS cost should fall through learning](#sap-ams-cost-should-fall-through-learning)
- [SAP AMS cost review checklist](#sap-ams-cost-review-checklist)
...
- Previous in the migration: [SAP AMS Is Not a Ticket Factory: What a Better Operating Model Looks Like](/blog/sap-ams-is-not-a-ticket-factory-what-a-better-operating-model-looks-like/)
- Next in the migration: [What Managers Should Know Before Adding AI to SAP Support](/blog/what-managers-should-know-before-adding-ai-to-sap-support/)
