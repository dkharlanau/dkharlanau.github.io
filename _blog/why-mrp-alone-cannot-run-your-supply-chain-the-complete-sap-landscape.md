---
layout: blog
title: "Why MRP Alone Cannot Run Your Supply Chain: The Complete SAP Landscape for Demand, Supply, and Replenishment Planning"
description: "moving dates; - cancelling proposals; - increasing quantities; - calling suppliers; - checking production capacity; - transferring stock between."
slug: why-mrp-alone-cannot-run-your-supply-chain-the-complete-sap-landscape
permalink: /blog/why-mrp-alone-cannot-run-your-supply-chain-the-complete-sap-landscape/
date: 2026-07-17
...
tags:
  ...
  - supply-chain
  - sap-architecture
canonical_url: https://dkharlanau.github.io/blog/why-mrp-alone-cannot-run-your-supply-chain-the-complete-sap-landscape/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 38
migration_sequence: 42
...
- [The first distinction: planning is not one process](#the-first-distinction-planning-is-not-one-process)
- [Strategic planning](#strategic-planning)
- [Tactical planning](#tactical-planning)
- [Operational planning](#operational-planning)
- [Execution](#execution)
- [The modern SAP planning stack](#the-modern-sap-planning-stack)
- [Part I: Where demand enters the process](#part-i-where-demand-enters-the-process)
- [SAP IBP for Demand](#sap-ibp-for-demand)
- [Demand sensing](#demand-sensing)
- [S&OP and Integrated Business Planning](#s-op-and-integrated-business-planning)
- [Part II: Inventory planning before replenishment](#part-ii-inventory-planning-before-replenishment)
- [SAP IBP for Inventory](#sap-ibp-for-inventory)
- [Static safety stock in S/4HANA](#static-safety-stock-in-s-4hana)
- [Part III: The main replenishment philosophies](#part-iii-the-main-replenishment-philosophies)
- [1. Deterministic MRP](#1-deterministic-mrp)
- [2. Reorder-point planning](#2-reorder-point-planning)
- [3. Forecast-based planning](#3-forecast-based-planning)
- [4. Time-phased planning](#4-time-phased-planning)
- [5. Kanban](#5-kanban)
- [6. Demand-Driven Replenishment and DDMRP](#6-demand-driven-replenishment-and-ddmrp)
- [7. Distribution replenishment](#7-distribution-replenishment)
- [8. Warehouse replenishment](#8-warehouse-replenishment)
- [Part IV: SAP IBP Response and Supply](#part-iv-sap-ibp-response-and-supply)
- [Supply planning](#supply-planning)
- [Heuristic planning](#heuristic-planning)
- [Optimization](#optimization)
- [Response management](#response-management)
- [Part V: SAP S/4HANA Demand Management](#part-v-sap-s-4hana-demand-management)
- [Make-to-stock](#make-to-stock)
- [Make-to-order](#make-to-order)
- [Assembly-to-order](#assembly-to-order)
- [Planning without final assembly](#planning-without-final-assembly)
- [Part VI: Predictive MRP](#part-vi-predictive-mrp)
- [Part VII: MRP Live in SAP S/4HANA](#part-vii-mrp-live-in-sap-s-4hana)
- [Step 1: Net-requirements calculation](#step-1-net-requirements-calculation)
- [Step 2: Lot sizing](#step-2-lot-sizing)
- [Step 3: Procurement type](#step-3-procurement-type)
- [Step 4: Scheduling](#step-4-scheduling)
- [Step 5: BOM explosion](#step-5-bom-explosion)
- [MRP outputs](#mrp-outputs)
- [MRP Areas](#mrp-areas)
- [MRP controller](#mrp-controller)
- [Planning time fence](#planning-time-fence)
- [Firming](#firming)
- [MRP exception messages](#mrp-exception-messages)
- [Monitor Material Coverage](#monitor-material-coverage)
- [Part VIII: Capacity — where ordinary MRP is not enough](#part-viii-capacity-where-ordinary-mrp-is-not-enough)
- [Capacity evaluation](#capacity-evaluation)
- [Embedded PP/DS](#embedded-pp-ds)
- [PP/DS planning methods](#pp-ds-planning-methods)
- [MRP Live and PP/DS coordination](#mrp-live-and-pp-ds-coordination)
- [Part IX: Procurement execution](#part-ix-procurement-execution)
...
- [Part X: SAP Business Network Supply Chain Collaboration](#part-x-sap-business-network-supply-chain-collaboration)
- [Forecast collaboration](#forecast-collaboration)
- [Purchase-order collaboration](#purchase-order-collaboration)
- [Inventory collaboration](#inventory-collaboration)
- [Manufacturing collaboration](#manufacturing-collaboration)
- [Part XI: Production execution](#part-xi-production-execution)
...
- [SAP Digital Manufacturing](#sap-digital-manufacturing)
- [Part XII: Warehouse replenishment and execution](#part-xii-warehouse-replenishment-and-execution)
- [Inbound execution](#inbound-execution)
- [Production supply](#production-supply)
- [Picking-location replenishment](#picking-location-replenishment)
- [Inventory status matters](#inventory-status-matters)
- [Part XIII: aATP and demand fulfilment](#part-xiii-aatp-and-demand-fulfilment)
- [Part XIV: The complete end-to-end planning process](#part-xiv-the-complete-end-to-end-planning-process)
- [Step 1: Collect demand signals](#step-1-collect-demand-signals)
- [Step 2: Create statistical forecast](#step-2-create-statistical-forecast)
- [Step 3: Create consensus demand](#step-3-create-consensus-demand)
- [Step 4: Set inventory policy](#step-4-set-inventory-policy)
- [Step 5: Build network supply plan](#step-5-build-network-supply-plan)
- [Step 6: Approve scenario](#step-6-approve-scenario)
- [Step 7: Transfer operational demand](#step-7-transfer-operational-demand)
- [Step 8: Run pMRP simulation where needed](#step-8-run-pmrp-simulation-where-needed)
- [Step 9: Run MRP Live](#step-9-run-mrp-live)
- [Step 10: Perform detailed planning](#step-10-perform-detailed-planning)
- [Step 11: Execute procurement collaboration](#step-11-execute-procurement-collaboration)
- [Step 12: Execute production](#step-12-execute-production)
- [Step 13: Execute warehouse and transportation](#step-13-execute-warehouse-and-transportation)
- [Step 14: Feed actuals back](#step-14-feed-actuals-back)
- [Part XV: Which solution should be used for which problem?](#part-xv-which-solution-should-be-used-for-which-problem)
- [Scenario 1: Simple consumables](#scenario-1-simple-consumables)
- [Scenario 2: Make-to-stock manufacturing](#scenario-2-make-to-stock-manufacturing)
- [Scenario 3: Constrained manufacturing](#scenario-3-constrained-manufacturing)
- [Scenario 4: Long global supply chain](#scenario-4-long-global-supply-chain)
- [Scenario 5: Volatile flow with long lead times](#scenario-5-volatile-flow-with-long-lead-times)
- [Scenario 6: Automotive JIT/JIS supply](#scenario-6-automotive-jit-jis-supply)
- [Scenario 7: Externally manufactured product](#scenario-7-externally-manufactured-product)
- [Scenario 8: Retail or distribution replenishment](#scenario-8-retail-or-distribution-replenishment)
- [Part XVI: Legacy SAP APO landscape and modern replacements](#part-xvi-legacy-sap-apo-landscape-and-modern-replacements)
...
- [Part XVIII: The most important master data](#part-xviii-the-most-important-master-data)
- [Product and location](#product-and-location)
- [Demand settings](#demand-settings)
- [MRP parameters](#mrp-parameters)
- [Procurement data](#procurement-data)
- [Production data](#production-data)
- [Inventory data](#inventory-data)
- [Logistics data](#logistics-data)
- [Part XIX: Planning horizons and ownership](#part-xix-planning-horizons-and-ownership)
...
- [Part XXII: A practical target architecture](#part-xxii-a-practical-target-architecture)
...
- Previous in the migration: [Your ATP Is Not a Stock Check: How SAP aATP, gATP, IBP, Allocation, and Backorder Processing Actually Work](/blog/your-atp-is-not-a-stock-check-how-sap-aatp-gatp-ibp-allocation-and/)
- Next in the migration: [Why SAP CAR Becomes the Most Important Retail System Nobody Can Clearly Explain](/blog/why-sap-car-becomes-the-most-important-retail-system-nobody-can-clearly/)
