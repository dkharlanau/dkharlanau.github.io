---
layout: blog
title: "How to Reduce Transportation Costs Without Destroying Delivery Reliability"
description: "Transportation planners are instructed to consolidate more orders and select cheaper carriers."
slug: how-to-reduce-transportation-costs-without-destroying-delivery
permalink: /blog/how-to-reduce-transportation-costs-without-destroying-delivery/
date: 2026-07-17
...
tags:
  - sap-logistics
  - supply-chain
canonical_url: https://dkharlanau.github.io/blog/how-to-reduce-transportation-costs-without-destroying-delivery/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 25
migration_sequence: 38
...
related_articles:
  ...
  - /blog/why-inventory-reduction-programmes-often-create-more-expedites/
---

## On this page

- [Freight cost is usually created before transportation planning begins](#freight-cost-is-usually-created-before-transportation-planning-begins)
- [Transportation cost has several layers](#transportation-cost-has-several-layers)
- [Start with the transportation demand profile](#start-with-the-transportation-demand-profile)
- [Service must be defined before transport is optimized](#service-must-be-defined-before-transport-is-optimized)
- [Transport planning begins with a reliable ready date](#transport-planning-begins-with-a-reliable-ready-date)
- [Order stability is a transport parameter](#order-stability-is-a-transport-parameter)
- [Consolidation is an economic decision, not a universal rule](#consolidation-is-an-economic-decision-not-a-universal-rule)
- [Vehicle utilization needs a complete definition](#vehicle-utilization-needs-a-complete-definition)
- [Packaging data is transportation data](#packaging-data-is-transportation-data)
- [Mode selection should consider total lead time and risk](#mode-selection-should-consider-total-lead-time-and-risk)
- [Stable lanes should use strategic planning](#stable-lanes-should-use-strategic-planning)
- [Contracts without compliance create false savings](#contracts-without-compliance-create-false-savings)
- [Tendering should balance rate, capacity, and reliability](#tendering-should-balance-rate-capacity-and-reliability)
- [Carrier performance must affect future allocation](#carrier-performance-must-affect-future-allocation)
- [Capacity reliability can be worth more than a low rate](#capacity-reliability-can-be-worth-more-than-a-low-rate)
- [Keep backup capacity deliberate](#keep-backup-capacity-deliberate)
- [Dock waiting is transportation cost](#dock-waiting-is-transportation-cost)
- [Warehouse and transport planning must use the same departure plan](#warehouse-and-transport-planning-must-use-the-same-departure-plan)
- [Visibility should trigger a decision](#visibility-should-trigger-a-decision)
- [Estimated arrival time should be compared with actual result](#estimated-arrival-time-should-be-compared-with-actual-result)
- [Freight settlement is an optimization source](#freight-settlement-is-an-optimization-source)
- [Accessorial charges deserve separate management](#accessorial-charges-deserve-separate-management)
- [Failed delivery is an end-to-end defect](#failed-delivery-is-an-end-to-end-defect)
- [Returns need planned transport flows](#returns-need-planned-transport-flows)
- [Sustainability and cost often share drivers](#sustainability-and-cost-often-share-drivers)
- [Do not automate a transport policy that does not exist](#do-not-automate-a-transport-policy-that-does-not-exist)
- [AI should explain transport decisions before it executes them](#ai-should-explain-transport-decisions-before-it-executes-them)
- [Build a transport decision architecture](#build-a-transport-decision-architecture)
- [Build a transportation KPI tree](#build-a-transportation-kpi-tree)
- [Measure premium freight as a failure process](#measure-premium-freight-as-a-failure-process)
- [Calculate transportation ROI carefully](#calculate-transportation-roi-carefully)
...
- [The goal is reliable movement at controlled total cost](#the-goal-is-reliable-movement-at-controlled-total-cost)
...
- Previous in the migration: [How to Reduce Warehouse Costs with SAP EWM Without Slowing Order Fulfilment](/blog/how-to-reduce-warehouse-costs-with-sap-ewm-without-slowing-order/)
- Next in the migration: [Do You Actually Need RISE with SAP? What It Is, What It Includes, and Where Companies Get Trapped](/blog/do-you-actually-need-rise-with-sap-what-it-is-what-it-includes-and/)
