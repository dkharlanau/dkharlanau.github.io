---
layout: blog
title: "Where Should Mapping Logic Live in Modern SAP Integrations?"
description: "A partner interface removes the value completely because its format does not support it."
slug: where-should-mapping-logic-live-in-modern-sap-integrations
permalink: /blog/where-should-mapping-logic-live-in-modern-sap-integrations/
date: 2026-07-17
...
tags:
  ...
  - integration
canonical_url: https://dkharlanau.github.io/blog/where-should-mapping-logic-live-in-modern-sap-integrations/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 26
migration_sequence: 24
...
- [Why mappings become hidden business systems](#why-mappings-become-hidden-business-systems)
- [The first principle: meaning belongs to the business domain](#the-first-principle-meaning-belongs-to-the-business-domain)
- [The second principle: target-specific logic should remain target-specific](#the-second-principle-target-specific-logic-should-remain-target-specific)
- [The third principle: middleware should translate, not become the policy owner](#the-third-principle-middleware-should-translate-not-become-the-policy-owner)
- [A decision framework for mapping placement](#a-decision-framework-for-mapping-placement)
- [When mapping should live in the source system](#when-mapping-should-live-in-the-source-system)
- [When mapping should live in the target system](#when-mapping-should-live-in-the-target-system)
- [When mapping should live in middleware](#when-mapping-should-live-in-middleware)
- [When a shared mapping service makes sense](#when-a-shared-mapping-service-makes-sense)
- [Mapping tables are not automatically master data](#mapping-tables-are-not-automatically-master-data)
- [Canonical models: useful tool or enterprise trap?](#canonical-models-useful-tool-or-enterprise-trap)
- [When a canonical model helps](#when-a-canonical-model-helps)
- [When a canonical model fails](#when-a-canonical-model-fails)
- [Prefer bounded canonical models](#prefer-bounded-canonical-models)
- [Direct mapping is not always bad](#direct-mapping-is-not-always-bad)
- [Mapping versioning must be explicit](#mapping-versioning-must-be-explicit)
- [Use additive evolution where possible](#use-additive-evolution-where-possible)
- [Defaults are business decisions](#defaults-are-business-decisions)
- [Do not confuse fallback with truth](#do-not-confuse-fallback-with-truth)
- [Mapping failures need their own exception model](#mapping-failures-need-their-own-exception-model)
- [Unknown values should fail visibly](#unknown-values-should-fail-visibly)
- [Never silently truncate or discard data](#never-silently-truncate-or-discard-data)
- [Mapping and reconciliation belong together](#mapping-and-reconciliation-belong-together)
- [Build mapping-level test cases](#build-mapping-level-test-cases)
- [Use production incidents to improve mapping tests](#use-production-incidents-to-improve-mapping-tests)
- [AI can accelerate mapping, but not approve semantics](#ai-can-accelerate-mapping-but-not-approve-semantics)
- [Require evidence for AI-generated mappings](#require-evidence-for-ai-generated-mappings)
- [Build a mapping registry](#build-a-mapping-registry)
- [A mapping registry should not become a spreadsheet graveyard](#a-mapping-registry-should-not-become-a-spreadsheet-graveyard)
- [Mapping governance can be lightweight](#mapping-governance-can-be-lightweight)
- [SAP integration governance should include mappings](#sap-integration-governance-should-include-mappings)
- [Example: where should sales organization determination live?](#example-where-should-sales-organization-determination-live)
- [Example: where should unit conversion live?](#example-where-should-unit-conversion-live)
- [Example: supplier classification mapping](#example-supplier-classification-mapping)
- [Example: B2B order mapping](#example-b2b-order-mapping)
- [Measure mapping quality](#measure-mapping-quality)
- [Common mistakes](#common-mistakes)
- [Questions architects and managers should ask](#questions-architects-and-managers-should-ask)
- [A practical mapping-design sequence](#a-practical-mapping-design-sequence)
- [The goal is visible business meaning](#the-goal-is-visible-business-meaning)
...
- Previous in the migration: [Modern SAP Integrations: How to Choose Between APIs, Events, Files, Queues, and Mapping Strategies](/blog/modern-sap-integrations-how-to-choose-between-apis-events-files-queues/)
- Next in the migration: [How to Design Event-Driven SAP Integrations Without Losing Control](/blog/how-to-design-event-driven-sap-integrations-without-losing-control/)
