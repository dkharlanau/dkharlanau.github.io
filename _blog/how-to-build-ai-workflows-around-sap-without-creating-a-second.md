---
layout: blog
title: "How to Build AI Workflows Around SAP Without Creating a Second Uncontrolled ERP"
description: "analyse blocked sales orders; - classify supplier confirmations; - resolve invoice discrepancies; - prepare material-master changes; - investigate."
slug: how-to-build-ai-workflows-around-sap-without-creating-a-second
permalink: /blog/how-to-build-ai-workflows-around-sap-without-creating-a-second/
date: 2026-07-17
author: "Dzmitryi Kharlanau"
language: en
category: "SAP data and AI"
tags:
  - sap-data-and-ai
  - ai-operations
canonical_url: https://dkharlanau.github.io/blog/how-to-build-ai-workflows-around-sap-without-creating-a-second/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 31
migration_sequence: 46
...
- [What is an AI workflow?](#what-is-an-ai-workflow)
- [1. Deterministic workflow](#1-deterministic-workflow)
- [2. Robotic process automation](#2-robotic-process-automation)
- [3. AI-assisted workflow](#3-ai-assisted-workflow)
- [4. Agentic workflow](#4-agentic-workflow)
- [5. Autonomous business agent](#5-autonomous-business-agent)
- [Where AI adds real value](#where-ai-adds-real-value)
- [Where AI usually adds little value](#where-ai-usually-adds-little-value)
- [The most useful design rule](#the-most-useful-design-rule)
- [The current SAP-native stack](#the-current-sap-native-stack)
- [SAP S/4HANA native workflow](#sap-s-4hana-native-workflow)
- [SAP Build Process Automation](#sap-build-process-automation)
- [Joule Studio](#joule-studio)
- [SAP AI services, models, and generative AI hub](#sap-ai-services-models-and-generative-ai-hub)
- [SAP Integration Suite](#sap-integration-suite)
- [Events and SAP transactions](#events-and-sap-transactions)
- [MCP and A2A](#mcp-and-a2a)
- [The main alternatives](#the-main-alternatives)
- [Camunda](#camunda)
- [Temporal](#temporal)
- [Microsoft Power Automate and Copilot Studio](#microsoft-power-automate-and-copilot-studio)
- [UiPath](#uipath)
...
- [The architecture I would use around SAP](#the-architecture-i-would-use-around-sap)
- [Layer 1: SAP transactional core](#layer-1-sap-transactional-core)
- [Layer 2: Governed action API](#layer-2-governed-action-api)
- [Layer 3: Integration boundary](#layer-3-integration-boundary)
- [Layer 4: Durable workflow engine](#layer-4-durable-workflow-engine)
- [Layer 5: AI reasoning service](#layer-5-ai-reasoning-service)
- [Layer 6: Human decision](#layer-6-human-decision)
- [Layer 7: Controlled execution](#layer-7-controlled-execution)
- [Layer 8: Evidence, observability, and evaluation](#layer-8-evidence-observability-and-evaluation)
- [Why the agent should not call SAP directly](#why-the-agent-should-not-call-sap-directly)
- [Excessive permissions](#excessive-permissions)
- [Missing business identity](#missing-business-identity)
- [Weak parameter control](#weak-parameter-control)
- [Concurrency risk](#concurrency-risk)
- [Retry risk](#retry-risk)
- [Poor segregation of duties](#poor-segregation-of-duties)
- [The transaction gateway pattern](#the-transaction-gateway-pattern)
- [Read tools and write tools should be separated](#read-tools-and-write-tools-should-be-separated)
- [Examples of good SAP AI workflows](#examples-of-good-sap-ai-workflows)
- [Use case 1: Sales-order delivery-block investigation](#use-case-1-sales-order-delivery-block-investigation)
- [Use case 2: Supplier confirmation processing](#use-case-2-supplier-confirmation-processing)
- [Use case 3: Supplier-invoice exception](#use-case-3-supplier-invoice-exception)
- [Use case 4: Material-master change proposal](#use-case-4-material-master-change-proposal)
- [Use case 5: Logistics exception investigation](#use-case-5-logistics-exception-investigation)
- [Use case 6: SAP support and incident triage](#use-case-6-sap-support-and-incident-triage)
- [Weak or dangerous use cases](#weak-or-dangerous-use-cases)
- [Autonomous pricing](#autonomous-pricing)
- [Autonomous payments](#autonomous-payments)
- [Unrestricted master-data maintenance](#unrestricted-master-data-maintenance)
- [Automatic inventory allocation](#automatic-inventory-allocation)
- [Automatic production-plan changes](#automatic-production-plan-changes)
- [Computer-use automation inside SAP](#computer-use-automation-inside-sap)
- [The hardest technical issues](#the-hardest-technical-issues)
- [Idempotency](#idempotency)
- [Concurrency](#concurrency)
- [Compensation](#compensation)
- [Long-running state](#long-running-state)
...
- [How I would choose the platform](#how-i-would-choose-the-platform)
- [SAP-heavy landscape with BTP already adopted](#sap-heavy-landscape-with-btp-already-adopted)
- [Cross-enterprise process with several major systems](#cross-enterprise-process-with-several-major-systems)
- [Engineering-led digital platform](#engineering-led-digital-platform)
- [Microsoft-dominant user environment](#microsoft-dominant-user-environment)
- [Legacy SAP GUI-heavy environment](#legacy-sap-gui-heavy-environment)
- [Rapid pilot](#rapid-pilot)
- [The first pilot I would implement](#the-first-pilot-i-would-implement)
- [Evaluation before autonomy](#evaluation-before-autonomy)
...
- Previous in the migration: [SAP EWM Explained: Processes, Integrations, Deployment Choices, and the Limitations Nobody Should Ignore](/blog/sap-ewm-explained-processes-integrations-deployment-choices-and-the/)
- Next in the migration: [SAP for Automotive Explained: The Complete Architecture from Engineering and JIT Supply to Vehicle Sales, Warranty, and Aftermarket](/blog/sap-for-automotive-explained-the-complete-architecture-from-engineering/)
