---
layout: blog
title: "Why SAP Knowledge Disappears After Every Support Transition"
description: "It makes hundreds of decisions about processes, configuration, master data, integrations, custom code, controls and local exceptions."
slug: why-sap-knowledge-disappears-after-every-support-transition
permalink: /blog/why-sap-knowledge-disappears-after-every-support-transition/
date: 2026-07-17
...
tags:
  - sap-ams-operations
  - sap-ams
canonical_url: https://dkharlanau.github.io/blog/why-sap-knowledge-disappears-after-every-support-transition/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 22
migration_sequence: 10
...
- [Knowledge transfer is often treated as an event](#knowledge-transfer-is-often-treated-as-an-event)
- [Documentation is not the same as knowledge](#documentation-is-not-the-same-as-knowledge)
- [SAP knowledge has several layers](#sap-knowledge-has-several-layers)
- [1. Process knowledge](#1-process-knowledge)
- [2. Solution knowledge](#2-solution-knowledge)
- [3. Decision knowledge](#3-decision-knowledge)
- [4. Operational knowledge](#4-operational-knowledge)
- [5. Ownership knowledge](#5-ownership-knowledge)
- [6. Historical knowledge](#6-historical-knowledge)
- [Projects and operations ask different questions](#projects-and-operations-ask-different-questions)
- [Knowledge disappears before the transition starts](#knowledge-disappears-before-the-transition-starts)
- [The final document is often written too late](#the-final-document-is-often-written-too-late)
- [Knowledge-transfer sessions create a false sense of completion](#knowledge-transfer-sessions-create-a-false-sense-of-completion)
- [The best transition test is a real problem](#the-best-transition-test-is-a-real-problem)
- [Hypercare knowledge is often lost](#hypercare-knowledge-is-often-lost)
- [A closed defect may contain more knowledge than a design document](#a-closed-defect-may-contain-more-knowledge-than-a-design-document)
- [Tool separation causes knowledge separation](#tool-separation-causes-knowledge-separation)
- [Central storage is not automatically a source of truth](#central-storage-is-not-automatically-a-source-of-truth)
- [Shadow knowledge grows when official knowledge is slow](#shadow-knowledge-grows-when-official-knowledge-is-slow)
- [Screenshots age quickly](#screenshots-age-quickly)
- [Architecture diagrams often show systems, not operations](#architecture-diagrams-often-show-systems-not-operations)
- [Runbooks are useful but can become dangerous](#runbooks-are-useful-but-can-become-dangerous)
- [Knowledge should be connected to evidence](#knowledge-should-be-connected-to-evidence)
- [Knowledge ownership is different from document ownership](#knowledge-ownership-is-different-from-document-ownership)
- [Provider transition creates a commercial tension](#provider-transition-creates-a-commercial-tension)
- [The customer must own the operational memory](#the-customer-must-own-the-operational-memory)
- [Provider-specific language creates dependency](#provider-specific-language-creates-dependency)
- [Knowledge transfer should include failure, not only normal flow](#knowledge-transfer-should-include-failure-not-only-normal-flow)
- [Knowledge transfer should include what is unknown](#knowledge-transfer-should-include-what-is-unknown)
- [The receiving team also has responsibilities](#the-receiving-team-also-has-responsibilities)
- [Access is part of knowledge readiness](#access-is-part-of-knowledge-readiness)
- [Knowledge should follow the business service](#knowledge-should-follow-the-business-service)
- [Monitoring knowledge is often missing from handover](#monitoring-knowledge-is-often-missing-from-handover)
- [Test cases are part of operational memory](#test-cases-are-part-of-operational-memory)
- [AI does not solve the handover problem automatically](#ai-does-not-solve-the-handover-problem-automatically)
- [A transition should produce operational memory](#a-transition-should-produce-operational-memory)
- [What a strong transition package contains](#what-a-strong-transition-package-contains)
- [1. Service catalogue](#1-service-catalogue)
- [2. Process maps](#2-process-maps)
- [3. Solution inventory](#3-solution-inventory)
- [4. Decision records](#4-decision-records)
- [5. Operational procedures](#5-operational-procedures)
- [6. Known errors and workarounds](#6-known-errors-and-workarounds)
- [7. Change and release history](#7-change-and-release-history)
- [8. Test assets](#8-test-assets)
- [9. Ownership directory](#9-ownership-directory)
- [10. Transition-risk backlog](#10-transition-risk-backlog)
- [Evidence-based knowledge transfer](#evidence-based-knowledge-transfer)
- [Reverse shadowing is more valuable than passive shadowing](#reverse-shadowing-is-more-valuable-than-passive-shadowing)
- [Knowledge-readiness metrics](#knowledge-readiness-metrics)
- [What managers should ask](#what-managers-should-ask)
- [A practical transition model](#a-practical-transition-model)
- [Knowledge must remain alive after transition](#knowledge-must-remain-alive-after-transition)
- [The real transition deliverable is independence](#the-real-transition-deliverable-is-independence)
- [Knowledge loss is an operating-model failure](#knowledge-loss-is-an-operating-model-failure)
- [SAP support-transition checklist](#sap-support-transition-checklist)
...
- Previous in the migration: [Why Traditional SAP AMS SLAs Reward the Wrong Behaviour](/blog/why-traditional-sap-ams-slas-reward-the-wrong-behaviour/)
- Next in the migration: [Where Automation Actually Makes Sense in SAP AMS](/blog/where-automation-actually-makes-sense-in-sap-ams/)
