---
layout: blog
title: "Why Traditional SAP AMS SLAs Reward the Wrong Behaviour"
description: "Ninety-eight percent of incidents met the agreed SLA. Priority-one tickets received a response within fifteen minutes. The backlog is under control."
slug: why-traditional-sap-ams-slas-reward-the-wrong-behaviour
permalink: /blog/why-traditional-sap-ams-slas-reward-the-wrong-behaviour/
date: 2026-07-17
...
tags:
  - sap-ams-operations
  - sap-ams
canonical_url: https://dkharlanau.github.io/blog/why-traditional-sap-ams-slas-reward-the-wrong-behaviour/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 22
migration_sequence: 9
...
- [An SLA is not automatically a measure of value](#an-sla-is-not-automatically-a-measure-of-value)
- [The SLA shapes the support organization](#the-sla-shapes-the-support-organization)
- [What traditional SAP AMS SLAs usually measure](#what-traditional-sap-ams-slas-usually-measure)
- [Response time can become a performance theatre](#response-time-can-become-a-performance-theatre)
- [Resolution time can reward temporary correction](#resolution-time-can-reward-temporary-correction)
- [Ticket closure is not business recovery](#ticket-closure-is-not-business-recovery)
- [Priority models often measure emotion instead of impact](#priority-models-often-measure-emotion-instead-of-impact)
- [The SLA begins too late](#the-sla-begins-too-late)
- [Availability can be technically correct and operationally misleading](#availability-can-be-technically-correct-and-operationally-misleading)
- [A service can meet SLA and still become worse](#a-service-can-meet-sla-and-still-become-worse)
- [Reopening rate is also easy to manipulate](#reopening-rate-is-also-easy-to-manipulate)
- [SLA clocks can create queue behaviour](#sla-clocks-can-create-queue-behaviour)
- [Multi-provider SLAs create local optimization](#multi-provider-slas-create-local-optimization)
- [Operational-level agreements are often invisible to the business](#operational-level-agreements-are-often-invisible-to-the-business)
- [SLA penalties rarely repair the business](#sla-penalties-rarely-repair-the-business)
- [The customer also influences SLA performance](#the-customer-also-influences-sla-performance)
- [Customer satisfaction scores can hide weak service](#customer-satisfaction-scores-can-hide-weak-service)
- [The real question: what behaviour does the SLA reward?](#the-real-question-what-behaviour-does-the-sla-reward)
- [Do not remove traditional SLA metrics](#do-not-remove-traditional-sla-metrics)
- [Layer 1: Access and response](#layer-1-access-and-response)
- [Layer 2: Business restoration](#layer-2-business-restoration)
- [Layer 3: Reliability](#layer-3-reliability)
- [Layer 4: Improvement and resilience](#layer-4-improvement-and-resilience)
- [Outcome-based SLAs need careful design](#outcome-based-slas-need-careful-design)
- [Measure time to ownership, not only time to response](#measure-time-to-ownership-not-only-time-to-response)
- [Measure restoration separately from resolution](#measure-restoration-separately-from-resolution)
- [Add a recurrence budget](#add-a-recurrence-budget)
- [Measure the age of known risk](#measure-the-age-of-known-risk)
- [Measure business service availability](#measure-business-service-availability)
- [Add quality gates for incident closure](#add-quality-gates-for-incident-closure)
- [Separate provider performance from landscape health](#separate-provider-performance-from-landscape-health)
- [A better commercial model](#a-better-commercial-model)
- [Fixed-price support can still reward improvement](#fixed-price-support-can-still-reward-improvement)
- [Automation can improve SLA while hiding instability](#automation-can-improve-sla-while-hiding-instability)
- [AI can make weak SLA behaviour faster](#ai-can-make-weak-sla-behaviour-faster)
- [Governance meetings should not begin with the SLA percentage](#governance-meetings-should-not-begin-with-the-sla-percentage)
- [A balanced monthly scorecard](#a-balanced-monthly-scorecard)
- [1. Business service health](#1-business-service-health)
- [2. Incident delivery](#2-incident-delivery)
- [3. Reliability](#3-reliability)
- [4. Improvement](#4-improvement)
- [5. Decisions required](#5-decisions-required)
- [Questions managers should ask](#questions-managers-should-ask)
- [A practical SLA redesign](#a-practical-sla-redesign)
- [The best SLA may include fewer metrics](#the-best-sla-may-include-fewer-metrics)
- [The goal is not to make the SLA more complicated](#the-goal-is-not-to-make-the-sla-more-complicated)
- [SAP AMS SLA review checklist](#sap-ams-sla-review-checklist)
...
- Previous in the migration: [Clean Core Does Not Mean Zero Complexity in SAP Operations](/blog/clean-core-does-not-mean-zero-complexity-in-sap-operations/)
- Next in the migration: [Why SAP Knowledge Disappears After Every Support Transition](/blog/why-sap-knowledge-disappears-after-every-support-transition/)
