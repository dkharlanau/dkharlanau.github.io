...
tags:
  ...
  - integration
  - sap-architecture
canonical_url: https://dkharlanau.github.io/blog/centralized-or-federated-sap-integration-architecture-how-to-divide/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 29
migration_sequence: 30
...
- [Integration architecture has two different problems](#integration-architecture-has-two-different-problems)
- [Centralized runtime is not centralized architecture](#centralized-runtime-is-not-centralized-architecture)
- [The platform team should own the integration control plane](#the-platform-team-should-own-the-integration-control-plane)
- [Domains should own the integration products](#domains-should-own-the-integration-products)
- [A federated model is not unrestricted decentralization](#a-federated-model-is-not-unrestricted-decentralization)
- [What should normally be centralized](#what-should-normally-be-centralized)
- [1. Platform selection and lifecycle](#1-platform-selection-and-lifecycle)
- [2. Identity and security foundations](#2-identity-and-security-foundations)
- [3. Development and deployment standards](#3-development-and-deployment-standards)
- [4. Common observability](#4-common-observability)
- [5. Integration catalogues](#5-integration-catalogues)
- [6. Approved architecture patterns](#6-approved-architecture-patterns)
- [7. Shared technical components](#7-shared-technical-components)
- [What should normally be federated](#what-should-normally-be-federated)
- [1. Business semantics](#1-business-semantics)
- [2. API product ownership](#2-api-product-ownership)
- [3. Event ownership](#3-event-ownership)
- [4. Mapping semantics](#4-mapping-semantics)
- [5. Business error handling](#5-business-error-handling)
- [6. Business reconciliation](#6-business-reconciliation)
- [The hardest responsibility: end-to-end process ownership](#the-hardest-responsibility-end-to-end-process-ownership)
- [Platform ownership, domain ownership and process ownership are different](#platform-ownership-domain-ownership-and-process-ownership-are-different)
- [Build a platform team, not an integration factory](#build-a-platform-team-not-an-integration-factory)
- [Self-service requires stronger controls, not fewer controls](#self-service-requires-stronger-controls-not-fewer-controls)
- [Use a paved road](#use-a-paved-road)
- [Do not centralize every mapping](#do-not-centralize-every-mapping)
- [A central canonical model is not a substitute for federation](#a-central-canonical-model-is-not-a-substitute-for-federation)
- [Domain contracts should be treated as products](#domain-contracts-should-be-treated-as-products)
- [API governance should not become approval theatre](#api-governance-should-not-become-approval-theatre)
- [Event governance needs consumer transparency](#event-governance-needs-consumer-transparency)
- [Separate event infrastructure from event ownership](#separate-event-infrastructure-from-event-ownership)
- [Integration engineering should become a distributed capability](#integration-engineering-should-become-a-distributed-capability)
- [Create an integration community of practice](#create-an-integration-community-of-practice)
- [Architecture governance needs decision rights](#architecture-governance-needs-decision-rights)
- [Local autonomy needs defined limits](#local-autonomy-needs-defined-limits)
- [Do not force local requirements into the global core](#do-not-force-local-requirements-into-the-global-core)
- [Funding determines architecture behaviour](#funding-determines-architecture-behaviour)
- [Chargeback models can create bad incentives](#chargeback-models-can-create-bad-incentives)
- [Measure total integration cost](#measure-total-integration-cost)
- [The platform team should publish service levels](#the-platform-team-should-publish-service-levels)
- [Domain teams must publish service expectations too](#domain-teams-must-publish-service-expectations-too)
- [Centralized monitoring needs distributed response](#centralized-monitoring-needs-distributed-response)
- [Incidents expose ownership quality](#incidents-expose-ownership-quality)
- [Replay authority must be distributed carefully](#replay-authority-must-be-distributed-carefully)
- [AI agents increase the need for federation](#ai-agents-increase-the-need-for-federation)
- [Do not expose the platform catalogue directly as an agent toolbox](#do-not-expose-the-platform-catalogue-directly-as-an-agent-toolbox)
- [Federated architecture needs a shared vocabulary](#federated-architecture-needs-a-shared-vocabulary)
- [Use bounded contexts to manage different meanings](#use-bounded-contexts-to-manage-different-meanings)
- [Create one architecture decision process](#create-one-architecture-decision-process)
- [Automate governance evidence](#automate-governance-evidence)
- [Governance automation cannot assess semantic quality alone](#governance-automation-cannot-assess-semantic-quality-alone)
- [A reference federated operating model](#a-reference-federated-operating-model)
- [1. Integration platform team](#1-integration-platform-team)
- [2. Enterprise integration architecture](#2-enterprise-integration-architecture)
- [3. Domain integration teams](#3-domain-integration-teams)
- [4. End-to-end process owners](#4-end-to-end-process-owners)
- [5. Integration operations](#5-integration-operations)
- [A practical responsibility matrix](#a-practical-responsibility-matrix)
- [A strong pilot for federation](#a-strong-pilot-for-federation)
- [Pilot scope](#pilot-scope)
- [Platform responsibilities](#platform-responsibilities)
- [Sales-domain responsibilities](#sales-domain-responsibilities)
- [Fulfilment responsibilities](#fulfilment-responsibilities)
- [Process-owner responsibilities](#process-owner-responsibilities)
- [Architecture responsibilities](#architecture-responsibilities)
- [Pilot success criteria](#pilot-success-criteria)
- [How to scale the model](#how-to-scale-the-model)
- [Phase 1: Define responsibilities](#phase-1-define-responsibilities)
- [Phase 2: Build the platform paved road](#phase-2-build-the-platform-paved-road)
- [Phase 3: Select mature domains](#phase-3-select-mature-domains)
- [Phase 4: Assign API and event owners](#phase-4-assign-api-and-event-owners)
- [Phase 5: Establish communities of practice](#phase-5-establish-communities-of-practice)
- [Phase 6: Automate governance checks](#phase-6-automate-governance-checks)
- [Phase 7: Introduce business reconciliation](#phase-7-introduce-business-reconciliation)
- [Phase 8: Measure bottlenecks and duplication](#phase-8-measure-bottlenecks-and-duplication)
- [Phase 9: Adjust decision rights](#phase-9-adjust-decision-rights)
- [Phase 10: Extend to agent integration](#phase-10-extend-to-agent-integration)
- [Metrics that reveal whether federation works](#metrics-that-reveal-whether-federation-works)
- [Central delivery queue time](#central-delivery-queue-time)
- [Domain-owned contract rate](#domain-owned-contract-rate)
- [Unknown-owner rate](#unknown-owner-rate)
- [Reuse without forks](#reuse-without-forks)
- [Architecture compliance](#architecture-compliance)
- [Exception volume](#exception-volume)
- [Consumer onboarding time](#consumer-onboarding-time)
- [Business-logic duplication](#business-logic-duplication)
- [Incident transfer rate](#incident-transfer-rate)
- [End-to-end reconciliation coverage](#end-to-end-reconciliation-coverage)
- [API version retirement time](#api-version-retirement-time)
- [Self-service success rate](#self-service-success-rate)
- [Platform bypass rate](#platform-bypass-rate)
- [Common mistakes](#common-mistakes)
- [Mistake 1: Centralizing all integration development](#mistake-1-centralizing-all-integration-development)
- [Mistake 2: Decentralizing without mandatory controls](#mistake-2-decentralizing-without-mandatory-controls)
- [Mistake 3: Treating the platform team as the business owner](#mistake-3-treating-the-platform-team-as-the-business-owner)
- [Mistake 4: Assigning an API owner only on paper](#mistake-4-assigning-an-api-owner-only-on-paper)
- [Mistake 5: Building self-service without a paved road](#mistake-5-building-self-service-without-a-paved-road)
- [Mistake 6: Forcing every local requirement into global APIs](#mistake-6-forcing-every-local-requirement-into-global-apis)
- [Mistake 7: Creating one central mapping team](#mistake-7-creating-one-central-mapping-team)
- [Mistake 8: Letting domains create private mappings](#mistake-8-letting-domains-create-private-mappings)
- [Mistake 9: Governing naming but not business behaviour](#mistake-9-governing-naming-but-not-business-behaviour)
- [Mistake 10: Assuming event consumers are optional because they are loosely coupled](#mistake-10-assuming-event-consumers-are-optional-because-they-are-loosely-coupled)
- [Mistake 11: Allowing the platform team to replay high-risk transactions independently](#mistake-11-allowing-the-platform-team-to-replay-high-risk-transactions-independently)
- [Mistake 12: Exposing all enterprise APIs to AI agents](#mistake-12-exposing-all-enterprise-apis-to-ai-agents)
- [Mistake 13: Measuring the number of integrations delivered](#mistake-13-measuring-the-number-of-integrations-delivered)
- [Mistake 14: Forgetting the end-to-end process owner](#mistake-14-forgetting-the-end-to-end-process-owner)
- [Questions managers and architects should ask](#questions-managers-and-architects-should-ask)
- [The goal is centralized control without centralized meaning](#the-goal-is-centralized-control-without-centralized-meaning)
...
- Previous in the migration: [How to Design a Transitional SAP Integration Architecture During an S/4HANA Transformation](/blog/how-to-design-a-transitional-sap-integration-architecture-during-an-s/)
- Next in the migration: [Why Green Interfaces Still Produce Broken Business Processes: Observability and Reconciliation in SAP Integration Architecture](/blog/why-green-interfaces-still-produce-broken-business-processes/)
