---
layout: blog
title: "SAP for Automotive Explained: The Complete Architecture from Engineering and JIT Supply to Vehicle Sales, Warranty, and Aftermarket"
description: "long-term forecasts; - delivery schedules; - just-in-time calls; - sequence calls; - engineering changes; - cumulative quantities; - self-billing."
slug: sap-for-automotive-explained-the-complete-architecture-from-engineering
permalink: /blog/sap-for-automotive-explained-the-complete-architecture-from-engineering/
date: 2026-07-17
...
tags:
  ...
  - sap-architecture
  - automotive
canonical_url: https://dkharlanau.github.io/blog/sap-for-automotive-explained-the-complete-architecture-from-engineering/
status: needs_verification
verified: false
robots: noindex,follow
sitemap: false
reading_time_minutes: 38
migration_sequence: 47
...
- [There is no single SAP Automotive architecture](#there-is-no-single-sap-automotive-architecture)
- [Automotive OEM](#automotive-oem)
- [Tier-1 supplier](#tier-1-supplier)
- [Tier-2 or component supplier](#tier-2-or-component-supplier)
- [National sales company or importer](#national-sales-company-or-importer)
- [Dealer group](#dealer-group)
- [Aftermarket and service organisation](#aftermarket-and-service-organisation)
- [The complete SAP Automotive architecture](#the-complete-sap-automotive-architecture)
- [Part I: Product development and the automotive digital thread](#part-i-product-development-and-the-automotive-digital-thread)
- [Engineering BOM versus manufacturing BOM](#engineering-bom-versus-manufacturing-bom)
- [Engineering change management](#engineering-change-management)
- [Software-defined vehicle problem](#software-defined-vehicle-problem)
- [Product Lifecycle Costing](#product-lifecycle-costing)
- [Part II: Configurable products and vehicle structures](#part-ii-configurable-products-and-vehicle-structures)
- [Variant configuration](#variant-configuration)
- [Configuration is not only sales logic](#configuration-is-not-only-sales-logic)
- [Super BOM and super routing](#super-bom-and-super-routing)
- [Configuration lifecycle](#configuration-lifecycle)
- [Part III: Demand in automotive is usually schedule-driven](#part-iii-demand-in-automotive-is-usually-schedule-driven)
- [Scheduling agreement](#scheduling-agreement)
- [Forecast delivery schedule](#forecast-delivery-schedule)
- [JIT delivery schedule or call](#jit-delivery-schedule-or-call)
- [Sequenced JIT call](#sequenced-jit-call)
- [Release horizons](#release-horizons)
- [EDI in automotive](#edi-in-automotive)
- [Cumulative quantities](#cumulative-quantities)
- [The most dangerous EDI mistake](#the-most-dangerous-edi-mistake)
- [Part IV: JIT and JIS](#part-iv-jit-and-jis)
- [Just in time](#just-in-time)
- [Just in sequence](#just-in-sequence)
- [A simplified JIS flow](#a-simplified-jis-flow)
- [Sequence reference](#sequence-reference)
- [JIS is fragile by design](#jis-is-fragile-by-design)
- [Sequence changes](#sequence-changes)
- [JIT/JIS systems boundary](#jit-jis-systems-boundary)
- [Do not use JIS where the process is not stable enough](#do-not-use-jis-where-the-process-is-not-stable-enough)
- [Part V: Supply planning and procurement](#part-v-supply-planning-and-procurement)
- [SAP IBP](#sap-ibp)
- [IBP is not JIT execution](#ibp-is-not-jit-execution)
- [S/4HANA MRP](#s-4hana-mrp)
- [PP/DS](#pp-ds)
- [Supplier collaboration](#supplier-collaboration)
- [Supplier commitment hierarchy](#supplier-commitment-hierarchy)
- [Quota and alternative sourcing](#quota-and-alternative-sourcing)
- [Part VI: Manufacturing and sequence execution](#part-vi-manufacturing-and-sequence-execution)
- [S/4HANA Manufacturing](#s-4hana-manufacturing)
- [Digital Manufacturing](#digital-manufacturing)
- [MES integration](#mes-integration)
- [Takt and production sequence](#takt-and-production-sequence)
- [Production backflush](#production-backflush)
- [Serialised genealogy](#serialised-genealogy)
- [Rework](#rework)
- [Part VII: Warehouse, line supply, and returnable packaging](#part-vii-warehouse-line-supply-and-returnable-packaging)
- [SAP EWM](#sap-ewm)
- [Production supply](#production-supply)
- [Warehouse supply versus JIT supply](#warehouse-supply-versus-jit-supply)
- [Handling units](#handling-units)
- [Returnable packaging](#returnable-packaging)
- [Returnable-container loop](#returnable-container-loop)
- [Container management limitations](#container-management-limitations)
- [Finished vehicle yard](#finished-vehicle-yard)
- [Part VIII: Transportation and inbound control](#part-viii-transportation-and-inbound-control)
- [SAP Transportation Management](#sap-transportation-management)
- [Inbound milk run](#inbound-milk-run)
- [JIT transport](#jit-transport)
- [TM and EWM integration](#tm-and-ewm-integration)
- [Global Trade Services](#global-trade-services)
- [Finished vehicle logistics](#finished-vehicle-logistics)
- [Part IX: Vehicle Management](#part-ix-vehicle-management)
- [Vehicle identity](#vehicle-identity)
- [Vehicle Management System](#vehicle-management-system)
- [Vehicle action and status model](#vehicle-action-and-status-model)
- [Why VMS implementations become complex](#why-vms-implementations-become-complex)
- [VMS is not automatically a modern dealer platform](#vms-is-not-automatically-a-modern-dealer-platform)
- [Vehicle object versus equipment](#vehicle-object-versus-equipment)
- [Part X: Sales, outbound logistics, and customer collaboration](#part-x-sales-outbound-logistics-and-customer-collaboration)
- [Sales scheduling agreement fulfilment](#sales-scheduling-agreement-fulfilment)
- [Delivery creation](#delivery-creation)
- [Advance shipping notification](#advance-shipping-notification)
- [Customer material number](#customer-material-number)
- [Pricing](#pricing)
- [Part XI: Self-billing](#part-xi-self-billing)
- [Self-billing process](#self-billing-process)
- [Common differences](#common-differences)
- [Self-billing is not simple EDI posting](#self-billing-is-not-simple-edi-posting)
- [Dangerous automation](#dangerous-automation)
- [Part XII: Quality, traceability, and complaints](#part-xii-quality-traceability-and-complaints)
- [Supplier quality collaboration](#supplier-quality-collaboration)
- [Complaint process](#complaint-process)
- [8D and corrective action](#8d-and-corrective-action)
- [Part traceability](#part-traceability)
- [Recall scope](#recall-scope)
- [Warranty](#warranty)
- [Warranty is both service and quality data](#warranty-is-both-service-and-quality-data)
- [Part XIII: Service and aftermarket](#part-xiii-service-and-aftermarket)
- [Extended service parts planning](#extended-service-parts-planning)
- [Service-parts supersession](#service-parts-supersession)
- [Intermittent demand](#intermittent-demand)
- [Service management](#service-management)
- [Repair process](#repair-process)
- [Remanufacturing](#remanufacturing)
- [Part XIV: Catena-X and SAP Industry Network for Automotive](#part-xiv-catena-x-and-sap-industry-network-for-automotive)
- [Catena-X is not one central database](#catena-x-is-not-one-central-database)
- [Potential use cases](#potential-use-cases)
- [Business Partner Number](#business-partner-number)
- [Eclipse Dataspace Connector](#eclipse-dataspace-connector)
- [Catena-X limitations](#catena-x-limitations)
- [Part XV: Finance and controlling](#part-xv-finance-and-controlling)
- [Product costing](#product-costing)
- [Actual cost and variance](#actual-cost-and-variance)
- [Tooling](#tooling)
- [Customer profitability](#customer-profitability)
- [Part XVI: System ownership](#part-xvi-system-ownership)
- [Part XVII: Integration architecture](#part-xvii-integration-architecture)
...
- [Part XVIII: Main limitations and traps](#part-xviii-main-limitations-and-traps)
- [Limitation 1: SAP for Automotive is not one licensed package](#limitation-1-sap-for-automotive-is-not-one-licensed-package)
- [Limitation 2: Private and public cloud scope differs](#limitation-2-private-and-public-cloud-scope-differs)
- [Limitation 3: Legacy automotive customisation is deep](#limitation-3-legacy-automotive-customisation-is-deep)
- [Limitation 4: Customer-specific EDI never disappears completely](#limitation-4-customer-specific-edi-never-disappears-completely)
- [Limitation 5: JIS has little tolerance for system failure](#limitation-5-jis-has-little-tolerance-for-system-failure)
- [Limitation 6: Several systems may own production sequence](#limitation-6-several-systems-may-own-production-sequence)
- [Limitation 7: Product configuration can become untestable](#limitation-7-product-configuration-can-become-untestable)
- [Limitation 8: Engineering and manufacturing structures diverge](#limitation-8-engineering-and-manufacturing-structures-diverge)
- [Limitation 9: Supplier collaboration depends on supplier maturity](#limitation-9-supplier-collaboration-depends-on-supplier-maturity)
- [Limitation 10: Cumulative quantity errors are financially material](#limitation-10-cumulative-quantity-errors-are-financially-material)
- [Limitation 11: Returnable packaging is often poorly scanned](#limitation-11-returnable-packaging-is-often-poorly-scanned)
- [Limitation 12: Traceability creates large data volume](#limitation-12-traceability-creates-large-data-volume)
- [Limitation 13: Dealer operations may need partner solutions](#limitation-13-dealer-operations-may-need-partner-solutions)
- [Limitation 14: Warranty remains disconnected from engineering](#limitation-14-warranty-remains-disconnected-from-engineering)
- [Limitation 15: Catena-X can become a technology programme without a use case](#limitation-15-catena-x-can-become-a-technology-programme-without-a-use-case)
- [Limitation 16: Automation reduces buffers but increases dependency](#limitation-16-automation-reduces-buffers-but-increases-dependency)
- [Part XIX: Architecture by company type](#part-xix-architecture-by-company-type)
- [OEM target architecture](#oem-target-architecture)
- [Tier-1 supplier target architecture](#tier-1-supplier-target-architecture)
- [Dealer or importer target architecture](#dealer-or-importer-target-architecture)
- [Aftermarket target architecture](#aftermarket-target-architecture)
- [Part XX: Implementation approach](#part-xx-implementation-approach)
- [Phase 1: Identify the business archetype](#phase-1-identify-the-business-archetype)
- [Phase 2: Map external commitments](#phase-2-map-external-commitments)
- [Phase 3: Establish product identity](#phase-3-establish-product-identity)
- [Phase 4: Design configuration governance](#phase-4-design-configuration-governance)
- [Phase 5: Choose planning authority](#phase-5-choose-planning-authority)
- [Phase 6: Build EDI canonical models](#phase-6-build-edi-canonical-models)
- [Phase 7: Design the exception model](#phase-7-design-the-exception-model)
- [Phase 8: Connect physical execution](#phase-8-connect-physical-execution)
- [Phase 9: Close the financial loop](#phase-9-close-the-financial-loop)
- [Phase 10: Close the product feedback loop](#phase-10-close-the-product-feedback-loop)
...
- Previous in the migration: [How to Build AI Workflows Around SAP Without Creating a Second Uncontrolled ERP](/blog/how-to-build-ai-workflows-around-sap-without-creating-a-second/)
- Next in the migration: [SAP Quality Management Explained: From Inspection Planning to Supplier Quality, Production Control, Complaints, CAPA, and Certificates](/blog/sap-quality-management-explained-from-inspection-planning-to-supplier/)
