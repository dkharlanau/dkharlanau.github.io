...
<div class="ddd-canvas">
  ...
  <header class="ddd-hero" aria-labelledby="ddd-title">
    <div>
      <p class="ddd-kicker">Working framework · v0.2</p>
      <h1 id="ddd-title">Domain-Driven Design for acting systems.</h1>
      <p class="ddd-hero__lead">DDD protects business meaning. I want to keep that discipline, but extend it for software that can interpret context, make a choice, delegate work, call a tool, and sometimes change real business state.</p>
    </div>
    <aside class="ddd-hero__aside" aria-label="Framework thesis">
      ...
      <p>My current formula is simple: Meaning → Decision → Commitment → Evidence → Learning.</p>
  ...
  <section class="ddd-section" aria-labelledby="ddd-why">
    <div class="ddd-section__head">
      ...
      <div>
        <p>I do not see AI as a reason to abandon bounded contexts or ubiquitous language. It is almost the opposite. Once a model can read business language and choose an action, semantic mistakes can become operational mistakes.</p>
    ...
    <div class="ddd-compare" style="margin-top:2.5rem">
      <article><h3>I keep bounded contexts.</h3><p>A model is valid inside a semantic boundary. Sales, Availability, Delivery, Finance, and Master Data may use the same word differently.</p></article>
      ...
      <article><h3>I keep invariants.</h3><p>If a rule must always hold, I still want deterministic logic to protect it. AI may explain the rule, not become the rule.</p></article>
  ...
  <section class="ddd-section" aria-labelledby="ddd-units">
    <div class="ddd-section__head">
      ...
      <p>The important change from v0.1 is that Context is not a unit of autonomy. It is a unit of semantic integrity. Autonomy belongs in the action plane.</p>
    </div>
  ...
  <section class="ddd-section" aria-labelledby="ddd-authority">
    ...
    <div class="ddd-compare">
      <article><h3>Scope</h3><p>Which customers, plants, company codes, materials, document types, or process variants are in scope?</p></article>
  ...
  <section class="ddd-section" aria-labelledby="ddd-autonomy">
    <div class="ddd-section__head">
      <div><p class="ddd-label">06 · Autonomy ladder</p><h2 id="ddd-autonomy">Attach autonomy to the action.</h2></div>
      <p>The same agent can be A0 for one decision and A3 for another. Authority belongs to the domain action, not to the personality of a bot.</p>
    </div>
    ...
    <div class="ddd-autonomy">
      ...
      <div class="ddd-autonomy__row"><span class="ddd-autonomy__level">A4</span><strong>Bounded execution</strong><p>Act without per-action approval inside a narrow authority envelope.</p><small>Use for low-risk, observable, reversible work.</small></div>
    </div>
  </section>

  <section class="ddd-section" aria-labelledby="ddd-economics">
    <div class="ddd-section__head">
      <div><p class="ddd-label">07 · Decision economics</p><h2 id="ddd-economics">Not every judgment deserves an agent.</h2></div>
      <p>AI adds uncertainty, latency, cost, evaluation work, and governance. It should earn its place in the process.</p>
    </div>

    <div class="ddd-compare">
      <article><h3>Good candidate</h3><p>High volume, several valid alternatives, useful context, bounded loss, and a reversible next step.</p></article>
      <article><h3>Keep deterministic</h3><p>A stable rule already gives the correct result, especially when it protects an invariant.</p></article>
      <article><h3>Keep approval</h3><p>The action is hard to reverse, creates a large financial or customer commitment, or uses weak evidence.</p></article>
      <article><h3>Measure the boring part</h3><p>Cost of delay, cost of error, review effort, evidence quality, and action volume matter more than model cleverness.</p></article>
    </div>
  </section>

  <section class="ddd-section" aria-labelledby="ddd-truth">
    <div class="ddd-section__head">
      <div><p class="ddd-label">08 · Truth and time</p><h2 id="ddd-truth">Correct data can still be wrong if it is old.</h2></div>
    ...
    <div class="ddd-memory">
      ...
      <article><strong>Event Memory</strong><p>What happened. Preserve event time, producer context, ordering assumptions, and schema meaning.</p><p class="ddd-memory__warning">Temporal fact, not current state by default</p></article>
  ...
  <section class="ddd-section" aria-labelledby="ddd-agents">
    <div class="ddd-section__head">
      <div><p class="ddd-label">09 · Agents and contracts</p><h2 id="ddd-agents">Protocols solve connectivity. They do not solve domain authority.</h2></div>
      <p>MCP can expose tools and resources. A2A can describe agents, tasks, and artifacts. These are useful technical contracts. I still need a business contract around meaning, authority, commitment, and evidence.</p>
    </div>
    ...
    <div class="ddd-artifacts">
      ...
      <article class="ddd-artifact"><h3>Evidence Contract</h3><p>Provenance and decision evidence that travels across a boundary without pretending to be domain truth.</p></article>
  ...
  <section class="ddd-section" aria-labelledby="ddd-learning">
    <div class="ddd-section__head">
      <div><p class="ddd-label">10 · Learning boundary</p><h2 id="ddd-learning">Learning is a promotion process, not self-editing.</h2></div>
  ...
  <section class="ddd-section" aria-labelledby="ddd-method">
    <div class="ddd-section__head">
      <div><p class="ddd-label">11 · Working method</p><h2 id="ddd-method">Explore → Bound → Contract → Decide → Commit → Observe → Learn.</h2></div>
    ...
    <div class="ddd-artifacts" style="margin-top:2.5rem">
      <article class="ddd-artifact"><h3>Context Card</h3><p>Language, scope, owners, systems of record, and context relationships.</p></article>
      <article class="ddd-artifact"><h3>Decision Card</h3><p>Truth, evidence, invariants, judgment, economics, authority, and candidate actions.</p></article>
      <article class="ddd-artifact"><h3>Commitment Card</h3><p>Business effect, owner, command, transaction boundary, event, and compensation.</p></article>
      <article class="ddd-artifact"><h3>Authority Envelope</h3><p>Scope, value, frequency, time, approval, and reversibility.</p></article>
      <article class="ddd-artifact"><h3>Agent Contract</h3><p>Home context, role, tools, reads, forbidden actions, delegation, autonomy, evidence, and escalation.</p></article>
      <article class="ddd-artifact"><h3>Learning Ledger</h3><p>Production evidence linked to evaluation cases, proposed changes, review, and promotion decisions.</p></article>
    </div>
  </section>

  <section class="ddd-section" aria-labelledby="ddd-sap">
    <div class="ddd-section__head">
      <div><p class="ddd-label">12 · SAP example</p><h2 id="ddd-sap">Delivery risk is a decision. Changing the promise is a commitment.</h2></div>
      <p>This distinction becomes useful very quickly in SAP logistics because several contexts can contribute facts, while only one context should own the customer commitment.</p>
    </div>

    <div class="ddd-system-map" aria-label="SAP order fulfillment example">
      <div class="ddd-system-map__node"><p class="ddd-label">Customer Order</p><strong>Owns the promise</strong><p>Sales order state, customer commitment, and the final promise-change command.</p></div>
      <div class="ddd-system-map__node"><p class="ddd-label">Availability</p><strong>Owns availability meaning</strong><p>ATP or aATP result is authoritative for the availability model, not the agent's interpretation.</p></div>
      <div class="ddd-system-map__node"><p class="ddd-label">Delivery Execution</p><strong>Owns execution state</strong><p>Delivery creation, picking, goods issue, and execution milestones belong here.</p></div>
      <div class="ddd-system-map__node"><p class="ddd-label">Transportation</p><strong>Owns transport facts</strong><p>Planning and execution facts enter through a contract when they matter for the promise.</p></div>
      <div class="ddd-system-map__node ddd-system-map__node--decision"><p class="ddd-label">Delivery Risk Advisor</p><strong>A1 by default</strong><p>Explains risk, ranks valid alternatives, and prepares a change. It does not invent stock or own the promise.</p></div>
    </div>

    <div class="ddd-note" style="margin-top:2.5rem">
      <p>Before a customer promise changes, re-read current order state and relevant ATP evidence, validate authority, execute one domain command, and record the resulting business event. That is much stronger than “the model called the sales-order API successfully”.</p>
    </div>
  </section>
  ...
  <section class="ddd-section" aria-labelledby="ddd-signals">
    <div class="ddd-section__head">
      ...
      <p>This framework is my synthesis, not a wrapper around a protocol. Still, current work around DDD and agent infrastructure points toward explicit context, tools, tasks, authorization, evidence, and observability.</p>
    </div>
    ...
    <div class="ddd-source-list">
      ...
      <a href="https://www.domainlanguage.com/articles/ai-components-deterministic-system/" rel="noopener"><strong>AI Components for a Deterministic System · Eric Evans</strong><span>A useful separation between probabilistic classification and domain modeling. It supports keeping model design deliberate.</span><i>↗</i></a>
      <a href="https://www.domainlanguage.com/articles/context-mapping-an-ai-based-component/" rel="noopener"><strong>Context Mapping with an AI-based Component · Eric Evans</strong><span>A 2026 primary discussion of placing a probabilistic component inside a structured deterministic system.</span><i>↗</i></a>
      <a href="https://blog.modelcontextprotocol.io/posts/2026-07-28/" rel="noopener"><strong>Model Context Protocol · 2026-07-28</strong><span>The current release moves toward stateless interaction, stronger authorization, explicit discovery, and task extensions.</span><i>↗</i></a>
      <a href="https://modelcontextprotocol.io/specification/draft/server/tools" rel="noopener"><strong>MCP Tools</strong><span>Tools can be exposed and filtered by authorization. I still keep domain authority separate from technical tool availability.</span><i>↗</i></a>
      <a href="https://a2a-protocol.org/dev/specification/" rel="noopener"><strong>Agent2Agent Protocol</strong><span>Tasks, artifacts, agent discovery, and remote execution make delegation a real architecture boundary.</span><i>↗</i></a>
      <a href="https://opentelemetry.io/docs/specs/semconv/registry/attributes/gen-ai/" rel="noopener"><strong>OpenTelemetry GenAI semantic conventions</strong><span>Model, retrieval, and tool execution are observable operations. Some traces may also contain sensitive data, so evidence design needs care.</span><i>↗</i></a>
  ...
  <section class="ddd-section" aria-labelledby="ddd-machine">
    <div class="ddd-machine-panel">
      <div>
        ...
        <h2 id="ddd-machine">The machine model is more strict than the prose.</h2>
        <p>The canonical JSON contains the three planes, eight design units, decision and commitment boundaries, authority envelopes, decision economics, integration contracts, learning rules, graph relations, anti-patterns, SAP example, and expected agent output.</p>
  ...
  <section class="ddd-section" aria-labelledby="ddd-close">
    <div class="ddd-section__head">
      ...
      <div>
        ...
        <p>The goal is not to make agents look safe on a diagram. The goal is to make business behavior understandable when humans, deterministic software, and probabilistic actors all participate in the same process.</p>
      </div>
    </div>
  </section>
</div>
